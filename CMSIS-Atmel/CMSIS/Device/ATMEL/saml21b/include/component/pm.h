...
#define PM_CTRLA_IORET              ((0x1) << PM_CTRLA_IORET_Pos)
#define PM_CTRLA_MASK               (0x04)     /**< \brief (PM_CTRLA) MASK Register */
...
#define PM_SLEEPCFG_RESETVALUE      (0x02);    /**< \brief (PM_SLEEPCFG reset_value) Sleep Configuration */

#define PM_SLEEPCFG_SLEEPMODE_Pos   0            /**< \brief (PM_SLEEPCFG) Sleep Mode */
#define PM_SLEEPCFG_SLEEPMODE_Msk   ((0x7) << PM_SLEEPCFG_SLEEPMODE_Pos)
#define PM_SLEEPCFG_SLEEPMODE(value) (PM_SLEEPCFG_SLEEPMODE_Msk & ((value) << PM_SLEEPCFG_SLEEPMODE_Pos))
#define   PM_SLEEPCFG_SLEEPMODE_IDLE_Val  (0x2)   /**< \brief (PM_SLEEPCFG) CPU, AHBx, and APBx clocks are OFF */
#define   PM_SLEEPCFG_SLEEPMODE_STANDBY_Val (0x4)   /**< \brief (PM_SLEEPCFG) All Clocks are OFF */
#define   PM_SLEEPCFG_SLEEPMODE_BACKUP_Val (0x5)   /**< \brief (PM_SLEEPCFG) Only Backup domain is powered ON */
#define   PM_SLEEPCFG_SLEEPMODE_OFF_Val   (0x6)   /**< \brief (PM_SLEEPCFG) All power domains are powered OFF */
...
#define PM_SLEEPCFG_MASK            (0x07)     /**< \brief (PM_SLEEPCFG) MASK Register */
...
#define PM_PLCFG_PLSEL_Msk          ((0x3) << PM_PLCFG_PLSEL_Pos)
#define PM_PLCFG_PLSEL(value)       (PM_PLCFG_PLSEL_Msk & ((value) << PM_PLCFG_PLSEL_Pos))
#define   PM_PLCFG_PLSEL_PL0_Val          (0x0)   /**< \brief (PM_PLCFG) Performance Level 0 */
#define   PM_PLCFG_PLSEL_PL1_Val          (0x1)   /**< \brief (PM_PLCFG) Performance Level 1 */
#define   PM_PLCFG_PLSEL_PL2_Val          (0x2)   /**< \brief (PM_PLCFG) Performance Level 2 */
...
#define PM_PLCFG_PLDIS              ((0x1) << PM_PLCFG_PLDIS_Pos)
#define PM_PLCFG_MASK               (0x83)     /**< \brief (PM_PLCFG) MASK Register */
...
#define PM_INTENCLR_PLRDY           ((0x1) << PM_INTENCLR_PLRDY_Pos)
#define PM_INTENCLR_MASK            (0x01)     /**< \brief (PM_INTENCLR) MASK Register */
...
#define PM_INTENSET_PLRDY           ((0x1) << PM_INTENSET_PLRDY_Pos)
#define PM_INTENSET_MASK            (0x01)     /**< \brief (PM_INTENSET) MASK Register */
...
#define PM_INTFLAG_PLRDY            ((0x1) << PM_INTFLAG_PLRDY_Pos)
#define PM_INTFLAG_MASK             (0x01)     /**< \brief (PM_INTFLAG) MASK Register */
...
#define PM_STDBYCFG_PDCFG_Msk       ((0x3) << PM_STDBYCFG_PDCFG_Pos)
#define PM_STDBYCFG_PDCFG(value)    (PM_STDBYCFG_PDCFG_Msk & ((value) << PM_STDBYCFG_PDCFG_Pos))
#define   PM_STDBYCFG_PDCFG_DEFAULT_Val   (0x0)   /**< \brief (PM_STDBYCFG) All power domains switching is handled by hardware. */
#define   PM_STDBYCFG_PDCFG_PD0_Val       (0x1)   /**< \brief (PM_STDBYCFG) PD0 is forced ACTIVE. PD1 and PD2 power domains switching is handled by hardware. */
#define   PM_STDBYCFG_PDCFG_PD01_Val      (0x2)   /**< \brief (PM_STDBYCFG) PD0 and PD1 are forced ACTIVE. PD2 power domain switching is handled by hardware. */
#define   PM_STDBYCFG_PDCFG_PD012_Val     (0x3)   /**< \brief (PM_STDBYCFG) All power domains are forced ACTIVE. */
...
#define PM_STDBYCFG_DPGPD0          ((0x1) << PM_STDBYCFG_DPGPD0_Pos)
#define PM_STDBYCFG_DPGPD1_Pos      5            /**< \brief (PM_STDBYCFG) Dynamic Power Gating for PD1 */
#define PM_STDBYCFG_DPGPD1          ((0x1) << PM_STDBYCFG_DPGPD1_Pos)
#define PM_STDBYCFG_VREGSMOD_Pos    6            /**< \brief (PM_STDBYCFG) Voltage Regulator Standby mode */
#define PM_STDBYCFG_VREGSMOD_Msk    ((0x3) << PM_STDBYCFG_VREGSMOD_Pos)
#define PM_STDBYCFG_VREGSMOD(value) (PM_STDBYCFG_VREGSMOD_Msk & ((value) << PM_STDBYCFG_VREGSMOD_Pos))
#define   PM_STDBYCFG_VREGSMOD_AUTO_Val   (0x0)   /**< \brief (PM_STDBYCFG) Automatic mode */
#define   PM_STDBYCFG_VREGSMOD_PERFORMANCE_Val (0x1)   /**< \brief (PM_STDBYCFG) Performance oriented */
#define   PM_STDBYCFG_VREGSMOD_LP_Val     (0x2)   /**< \brief (PM_STDBYCFG) Low Power oriented */
...
#define PM_STDBYCFG_LINKPD_Msk      ((0x3) << PM_STDBYCFG_LINKPD_Pos)
#define PM_STDBYCFG_LINKPD(value)   (PM_STDBYCFG_LINKPD_Msk & ((value) << PM_STDBYCFG_LINKPD_Pos))
#define   PM_STDBYCFG_LINKPD_DEFAULT_Val  (0x0)   /**< \brief (PM_STDBYCFG) Power domains are not linked */
#define   PM_STDBYCFG_LINKPD_PD01_Val     (0x1)   /**< \brief (PM_STDBYCFG) PD0 and PD1 power domains are linked */
#define   PM_STDBYCFG_LINKPD_PD12_Val     (0x2)   /**< \brief (PM_STDBYCFG) PD1 and PD2 power domains are linked */
#define   PM_STDBYCFG_LINKPD_PD012_Val    (0x3)   /**< \brief (PM_STDBYCFG) All power domains are linked */
...
#define PM_STDBYCFG_BBIASHS_Msk     ((0x3) << PM_STDBYCFG_BBIASHS_Pos)
...
#define PM_STDBYCFG_BBIASLP_Msk     ((0x3) << PM_STDBYCFG_BBIASLP_Pos)
...
#define PM_STDBYCFG_BBIASPP_Msk     ((0x3) << PM_STDBYCFG_BBIASPP_Pos)
#define PM_STDBYCFG_BBIASPP(value)  (PM_STDBYCFG_BBIASPP_Msk & ((value) << PM_STDBYCFG_BBIASPP_Pos))
#define PM_STDBYCFG_MASK            (0xFFF3)   /**< \brief (PM_STDBYCFG) MASK Register */
...
#define PM_PWSAKDLY_DLYVAL_Msk      ((0x7F) << PM_PWSAKDLY_DLYVAL_Pos)
...
#define PM_PWSAKDLY_IGNACK          ((0x1) << PM_PWSAKDLY_IGNACK_Pos)
#define PM_PWSAKDLY_MASK            (0xFF)     /**< \brief (PM_PWSAKDLY) MASK Register */
