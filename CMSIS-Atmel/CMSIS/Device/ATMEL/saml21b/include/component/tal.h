...
#define TAL_CTRLA_SWRST             ((0x1) << TAL_CTRLA_SWRST_Pos)
#define TAL_CTRLA_ENABLE_Pos        1            /**< \brief (TAL_CTRLA) Enable */
#define TAL_CTRLA_ENABLE            ((0x1) << TAL_CTRLA_ENABLE_Pos)
#define TAL_CTRLA_MASK              (0x03)     /**< \brief (TAL_CTRLA) MASK Register */
...
#define TAL_RSTCTRL_MASK            (0x00)     /**< \brief (TAL_RSTCTRL) MASK Register */
...
#define TAL_EXTCTRL_ENABLE          ((0x1) << TAL_EXTCTRL_ENABLE_Pos)
#define TAL_EXTCTRL_INV_Pos         1            /**< \brief (TAL_EXTCTRL) Invert BRK Pin */
#define TAL_EXTCTRL_INV             ((0x1) << TAL_EXTCTRL_INV_Pos)
#define TAL_EXTCTRL_MASK            (0x03)     /**< \brief (TAL_EXTCTRL) MASK Register */
...
#define TAL_EVCTRL_BRKEI            ((0x1) << TAL_EVCTRL_BRKEI_Pos)
#define TAL_EVCTRL_BRKEO_Pos        1            /**< \brief (TAL_EVCTRL) Break Output Event Enable */
#define TAL_EVCTRL_BRKEO            ((0x1) << TAL_EVCTRL_BRKEO_Pos)
#define TAL_EVCTRL_MASK             (0x03)     /**< \brief (TAL_EVCTRL) MASK Register */
...
#define TAL_INTENCLR_BRK            ((0x1) << TAL_INTENCLR_BRK_Pos)
#define TAL_INTENCLR_MASK           (0x01)     /**< \brief (TAL_INTENCLR) MASK Register */
...
#define TAL_INTENSET_BRK            ((0x1) << TAL_INTENSET_BRK_Pos)
#define TAL_INTENSET_MASK           (0x01)     /**< \brief (TAL_INTENSET) MASK Register */
...
#define TAL_INTFLAG_BRK             ((0x1) << TAL_INTFLAG_BRK_Pos)
#define TAL_INTFLAG_MASK            (0x01)     /**< \brief (TAL_INTFLAG) MASK Register */
...
#define TAL_GLOBMASK_CM0P           ((0x1) << TAL_GLOBMASK_CM0P_Pos)
#define TAL_GLOBMASK_PPP_Pos        1            /**< \brief (TAL_GLOBMASK) PPP Break Master */
#define TAL_GLOBMASK_PPP            ((0x1) << TAL_GLOBMASK_PPP_Pos)
#define TAL_GLOBMASK_EVBRK_Pos      6            /**< \brief (TAL_GLOBMASK) Event Break Master */
#define TAL_GLOBMASK_EVBRK          ((0x1) << TAL_GLOBMASK_EVBRK_Pos)
#define TAL_GLOBMASK_EXTBRK_Pos     7            /**< \brief (TAL_GLOBMASK) External Break Master */
#define TAL_GLOBMASK_EXTBRK         ((0x1) << TAL_GLOBMASK_EXTBRK_Pos)
#define TAL_GLOBMASK_MASK           (0xC3)     /**< \brief (TAL_GLOBMASK) MASK Register */
...
#define TAL_HALT_CM0P               ((0x1) << TAL_HALT_CM0P_Pos)
#define TAL_HALT_PPP_Pos            1            /**< \brief (TAL_HALT) PPP Break Master */
#define TAL_HALT_PPP                ((0x1) << TAL_HALT_PPP_Pos)
#define TAL_HALT_EVBRK_Pos          6            /**< \brief (TAL_HALT) Event Break Master */
#define TAL_HALT_EVBRK              ((0x1) << TAL_HALT_EVBRK_Pos)
#define TAL_HALT_EXTBRK_Pos         7            /**< \brief (TAL_HALT) External Break Master */
#define TAL_HALT_EXTBRK             ((0x1) << TAL_HALT_EXTBRK_Pos)
#define TAL_HALT_MASK               (0xC3)     /**< \brief (TAL_HALT) MASK Register */
...
#define TAL_RESTART_CM0P            ((0x1) << TAL_RESTART_CM0P_Pos)
#define TAL_RESTART_PPP_Pos         1            /**< \brief (TAL_RESTART) PPP Break Master */
#define TAL_RESTART_PPP             ((0x1) << TAL_RESTART_PPP_Pos)
#define TAL_RESTART_EXTBRK_Pos      7            /**< \brief (TAL_RESTART) External Break Master */
#define TAL_RESTART_EXTBRK          ((0x1) << TAL_RESTART_EXTBRK_Pos)
#define TAL_RESTART_MASK            (0x83)     /**< \brief (TAL_RESTART) MASK Register */
...
#define TAL_BRKSTATUS_CM0P_Msk      ((0x3) << TAL_BRKSTATUS_CM0P_Pos)
...
#define TAL_BRKSTATUS_PPP_Msk       ((0x3) << TAL_BRKSTATUS_PPP_Pos)
...
#define TAL_BRKSTATUS_EVBRK_Msk     ((0x3) << TAL_BRKSTATUS_EVBRK_Pos)
...
#define TAL_BRKSTATUS_EXTBRK_Msk    ((0x3) << TAL_BRKSTATUS_EXTBRK_Pos)
#define TAL_BRKSTATUS_EXTBRK(value) (TAL_BRKSTATUS_EXTBRK_Msk & ((value) << TAL_BRKSTATUS_EXTBRK_Pos))
#define TAL_BRKSTATUS_MASK          (0xF00F)   /**< \brief (TAL_BRKSTATUS) MASK Register */
...
#define TAL_CTICTRLA_ACTION_Msk     ((0x3) << TAL_CTICTRLA_ACTION_Pos)
#define TAL_CTICTRLA_ACTION(value)  (TAL_CTICTRLA_ACTION_Msk & ((value) << TAL_CTICTRLA_ACTION_Pos))
#define   TAL_CTICTRLA_ACTION_BREAK_Val   (0x0)   /**< \brief (TAL_CTICTRLA) Break when requested */
#define   TAL_CTICTRLA_ACTION_INTERRUPT_Val (0x1)   /**< \brief (TAL_CTICTRLA) Trigger DBG interrupt instead of break */
#define   TAL_CTICTRLA_ACTION_IGNORE_Val  (0x2)   /**< \brief (TAL_CTICTRLA) Ignore break request */
...
#define TAL_CTICTRLA_RESTART        ((0x1) << TAL_CTICTRLA_RESTART_Pos)
#define TAL_CTICTRLA_MASK           (0x07)     /**< \brief (TAL_CTICTRLA) MASK Register */
...
#define TAL_CTIMASK_CM0P            ((0x1) << TAL_CTIMASK_CM0P_Pos)
#define TAL_CTIMASK_PPP_Pos         1            /**< \brief (TAL_CTIMASK) PPP Break Master */
#define TAL_CTIMASK_PPP             ((0x1) << TAL_CTIMASK_PPP_Pos)
#define TAL_CTIMASK_EVBRK_Pos       6            /**< \brief (TAL_CTIMASK) Event Break Master */
#define TAL_CTIMASK_EVBRK           ((0x1) << TAL_CTIMASK_EVBRK_Pos)
#define TAL_CTIMASK_EXTBRK_Pos      7            /**< \brief (TAL_CTIMASK) External Break Master */
#define TAL_CTIMASK_EXTBRK          ((0x1) << TAL_CTIMASK_EXTBRK_Pos)
#define TAL_CTIMASK_MASK            (0xC3)     /**< \brief (TAL_CTIMASK) MASK Register */
...
#define TAL_INTSTATUS_IRQ_Msk       ((0xFF) << TAL_INTSTATUS_IRQ_Pos)
#define TAL_INTSTATUS_IRQ(value)    (TAL_INTSTATUS_IRQ_Msk & ((value) << TAL_INTSTATUS_IRQ_Pos))
#define TAL_INTSTATUS_MASK          (0xFF)     /**< \brief (TAL_INTSTATUS) MASK Register */
...
#define TAL_DMACPUSEL0_CH0_Msk      ((0x1) << TAL_DMACPUSEL0_CH0_Pos)
...
#define TAL_DMACPUSEL0_CH1_Msk      ((0x1) << TAL_DMACPUSEL0_CH1_Pos)
...
#define TAL_DMACPUSEL0_CH2_Msk      ((0x1) << TAL_DMACPUSEL0_CH2_Pos)
...
#define TAL_DMACPUSEL0_CH3_Msk      ((0x1) << TAL_DMACPUSEL0_CH3_Pos)
...
#define TAL_DMACPUSEL0_CH4_Msk      ((0x1) << TAL_DMACPUSEL0_CH4_Pos)
...
#define TAL_DMACPUSEL0_CH5_Msk      ((0x1) << TAL_DMACPUSEL0_CH5_Pos)
...
#define TAL_DMACPUSEL0_CH6_Msk      ((0x1) << TAL_DMACPUSEL0_CH6_Pos)
...
#define TAL_DMACPUSEL0_CH7_Msk      ((0x1) << TAL_DMACPUSEL0_CH7_Pos)
...
#define TAL_DMACPUSEL0_CH8_Msk      ((0x1) << TAL_DMACPUSEL0_CH8_Pos)
...
#define TAL_DMACPUSEL0_CH9_Msk      ((0x1) << TAL_DMACPUSEL0_CH9_Pos)
...
#define TAL_DMACPUSEL0_CH10_Msk     ((0x1) << TAL_DMACPUSEL0_CH10_Pos)
...
#define TAL_DMACPUSEL0_CH11_Msk     ((0x1) << TAL_DMACPUSEL0_CH11_Pos)
...
#define TAL_DMACPUSEL0_CH12_Msk     ((0x1) << TAL_DMACPUSEL0_CH12_Pos)
...
#define TAL_DMACPUSEL0_CH13_Msk     ((0x1) << TAL_DMACPUSEL0_CH13_Pos)
...
#define TAL_DMACPUSEL0_CH14_Msk     ((0x1) << TAL_DMACPUSEL0_CH14_Pos)
...
#define TAL_DMACPUSEL0_CH15_Msk     ((0x1) << TAL_DMACPUSEL0_CH15_Pos)
#define TAL_DMACPUSEL0_CH15(value)  (TAL_DMACPUSEL0_CH15_Msk & ((value) << TAL_DMACPUSEL0_CH15_Pos))
#define TAL_DMACPUSEL0_MASK         (0x55555555) /**< \brief (TAL_DMACPUSEL0) MASK Register */
...
#define TAL_EVCPUSEL0_CH0_Msk       ((0x1) << TAL_EVCPUSEL0_CH0_Pos)
...
#define TAL_EVCPUSEL0_CH1_Msk       ((0x1) << TAL_EVCPUSEL0_CH1_Pos)
...
#define TAL_EVCPUSEL0_CH2_Msk       ((0x1) << TAL_EVCPUSEL0_CH2_Pos)
...
#define TAL_EVCPUSEL0_CH3_Msk       ((0x1) << TAL_EVCPUSEL0_CH3_Pos)
...
#define TAL_EVCPUSEL0_CH4_Msk       ((0x1) << TAL_EVCPUSEL0_CH4_Pos)
...
#define TAL_EVCPUSEL0_CH5_Msk       ((0x1) << TAL_EVCPUSEL0_CH5_Pos)
...
#define TAL_EVCPUSEL0_CH6_Msk       ((0x1) << TAL_EVCPUSEL0_CH6_Pos)
...
#define TAL_EVCPUSEL0_CH7_Msk       ((0x1) << TAL_EVCPUSEL0_CH7_Pos)
...
#define TAL_EVCPUSEL0_CH8_Msk       ((0x1) << TAL_EVCPUSEL0_CH8_Pos)
...
#define TAL_EVCPUSEL0_CH9_Msk       ((0x1) << TAL_EVCPUSEL0_CH9_Pos)
...
#define TAL_EVCPUSEL0_CH10_Msk      ((0x1) << TAL_EVCPUSEL0_CH10_Pos)
...
#define TAL_EVCPUSEL0_CH11_Msk      ((0x1) << TAL_EVCPUSEL0_CH11_Pos)
#define TAL_EVCPUSEL0_CH11(value)   (TAL_EVCPUSEL0_CH11_Msk & ((value) << TAL_EVCPUSEL0_CH11_Pos))
#define TAL_EVCPUSEL0_MASK          (0x00555555) /**< \brief (TAL_EVCPUSEL0) MASK Register */
...
#define TAL_EICCPUSEL0_EXTINT0_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT0_Pos)
...
#define TAL_EICCPUSEL0_EXTINT1_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT1_Pos)
...
#define TAL_EICCPUSEL0_EXTINT2_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT2_Pos)
...
#define TAL_EICCPUSEL0_EXTINT3_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT3_Pos)
...
#define TAL_EICCPUSEL0_EXTINT4_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT4_Pos)
...
#define TAL_EICCPUSEL0_EXTINT5_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT5_Pos)
...
#define TAL_EICCPUSEL0_EXTINT6_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT6_Pos)
...
#define TAL_EICCPUSEL0_EXTINT7_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT7_Pos)
...
#define TAL_EICCPUSEL0_EXTINT8_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT8_Pos)
...
#define TAL_EICCPUSEL0_EXTINT9_Msk  ((0x1) << TAL_EICCPUSEL0_EXTINT9_Pos)
...
#define TAL_EICCPUSEL0_EXTINT10_Msk ((0x1) << TAL_EICCPUSEL0_EXTINT10_Pos)
...
#define TAL_EICCPUSEL0_EXTINT11_Msk ((0x1) << TAL_EICCPUSEL0_EXTINT11_Pos)
...
#define TAL_EICCPUSEL0_EXTINT12_Msk ((0x1) << TAL_EICCPUSEL0_EXTINT12_Pos)
...
#define TAL_EICCPUSEL0_EXTINT13_Msk ((0x1) << TAL_EICCPUSEL0_EXTINT13_Pos)
...
#define TAL_EICCPUSEL0_EXTINT14_Msk ((0x1) << TAL_EICCPUSEL0_EXTINT14_Pos)
...
#define TAL_EICCPUSEL0_EXTINT15_Msk ((0x1) << TAL_EICCPUSEL0_EXTINT15_Pos)
#define TAL_EICCPUSEL0_EXTINT15(value) (TAL_EICCPUSEL0_EXTINT15_Msk & ((value) << TAL_EICCPUSEL0_EXTINT15_Pos))
#define TAL_EICCPUSEL0_MASK         (0x55555555) /**< \brief (TAL_EICCPUSEL0) MASK Register */
...
#define TAL_INTCPUSEL0_SYSTEM_Msk   ((0x1) << TAL_INTCPUSEL0_SYSTEM_Pos)
...
#define TAL_INTCPUSEL0_WDT_Msk      ((0x1) << TAL_INTCPUSEL0_WDT_Pos)
...
#define TAL_INTCPUSEL0_RTC_Msk      ((0x1) << TAL_INTCPUSEL0_RTC_Pos)
...
#define TAL_INTCPUSEL0_NVMCTRL_Msk  ((0x1) << TAL_INTCPUSEL0_NVMCTRL_Pos)
...
#define TAL_INTCPUSEL0_USB_Msk      ((0x1) << TAL_INTCPUSEL0_USB_Pos)
...
#define TAL_INTCPUSEL0_SERCOM0_Msk  ((0x1) << TAL_INTCPUSEL0_SERCOM0_Pos)
...
#define TAL_INTCPUSEL0_SERCOM1_Msk  ((0x1) << TAL_INTCPUSEL0_SERCOM1_Pos)
...
#define TAL_INTCPUSEL0_SERCOM2_Msk  ((0x1) << TAL_INTCPUSEL0_SERCOM2_Pos)
...
#define TAL_INTCPUSEL0_SERCOM3_Msk  ((0x1) << TAL_INTCPUSEL0_SERCOM3_Pos)
...
#define TAL_INTCPUSEL0_SERCOM4_Msk  ((0x1) << TAL_INTCPUSEL0_SERCOM4_Pos)
...
#define TAL_INTCPUSEL0_SERCOM5_Msk  ((0x1) << TAL_INTCPUSEL0_SERCOM5_Pos)
...
#define TAL_INTCPUSEL0_TCC0_Msk     ((0x1) << TAL_INTCPUSEL0_TCC0_Pos)
...
#define TAL_INTCPUSEL0_TCC1_Msk     ((0x1) << TAL_INTCPUSEL0_TCC1_Pos)
#define TAL_INTCPUSEL0_TCC1(value)  (TAL_INTCPUSEL0_TCC1_Msk & ((value) << TAL_INTCPUSEL0_TCC1_Pos))
#define TAL_INTCPUSEL0_MASK         (0x55551115) /**< \brief (TAL_INTCPUSEL0) MASK Register */
...
#define TAL_INTCPUSEL1_TCC2_Msk     ((0x1) << TAL_INTCPUSEL1_TCC2_Pos)
...
#define TAL_INTCPUSEL1_TC0_Msk      ((0x1) << TAL_INTCPUSEL1_TC0_Pos)
...
#define TAL_INTCPUSEL1_TC1_Msk      ((0x1) << TAL_INTCPUSEL1_TC1_Pos)
...
#define TAL_INTCPUSEL1_TC2_Msk      ((0x1) << TAL_INTCPUSEL1_TC2_Pos)
...
#define TAL_INTCPUSEL1_TC3_Msk      ((0x1) << TAL_INTCPUSEL1_TC3_Pos)
...
#define TAL_INTCPUSEL1_TC4_Msk      ((0x1) << TAL_INTCPUSEL1_TC4_Pos)
...
#define TAL_INTCPUSEL1_ADC_Msk      ((0x1) << TAL_INTCPUSEL1_ADC_Pos)
...
#define TAL_INTCPUSEL1_AC_Msk       ((0x1) << TAL_INTCPUSEL1_AC_Pos)
...
#define TAL_INTCPUSEL1_DAC_Msk      ((0x1) << TAL_INTCPUSEL1_DAC_Pos)
...
#define TAL_INTCPUSEL1_PTC_Msk      ((0x1) << TAL_INTCPUSEL1_PTC_Pos)
...
#define TAL_INTCPUSEL1_AES_Msk      ((0x1) << TAL_INTCPUSEL1_AES_Pos)
...
#define TAL_INTCPUSEL1_TRNG_Msk     ((0x1) << TAL_INTCPUSEL1_TRNG_Pos)
...
#define TAL_INTCPUSEL1_PICOP_Msk    ((0x1) << TAL_INTCPUSEL1_PICOP_Pos)
#define TAL_INTCPUSEL1_PICOP(value) (TAL_INTCPUSEL1_PICOP_Msk & ((value) << TAL_INTCPUSEL1_PICOP_Pos))
#define TAL_INTCPUSEL1_MASK         (0x01555555) /**< \brief (TAL_INTCPUSEL1) MASK Register */
...
#define TAL_IRQTRIG_ENABLE          ((0x1) << TAL_IRQTRIG_ENABLE_Pos)
#define TAL_IRQTRIG_IRQNUM_Pos      1            /**< \brief (TAL_IRQTRIG) Interrupt Request Number */
#define TAL_IRQTRIG_IRQNUM_Msk      ((0x1F) << TAL_IRQTRIG_IRQNUM_Pos)
...
#define TAL_IRQTRIG_OVERRIDE_Msk    ((0xFF) << TAL_IRQTRIG_OVERRIDE_Pos)
#define TAL_IRQTRIG_OVERRIDE(value) (TAL_IRQTRIG_OVERRIDE_Msk & ((value) << TAL_IRQTRIG_OVERRIDE_Pos))
#define TAL_IRQTRIG_MASK            (0xFF3F)   /**< \brief (TAL_IRQTRIG) MASK Register */
...
#define TAL_CPUIRQS_CPUIRQS_Msk     ((0x1FFFFFFF) << TAL_CPUIRQS_CPUIRQS_Pos)
#define TAL_CPUIRQS_CPUIRQS(value)  (TAL_CPUIRQS_CPUIRQS_Msk & ((value) << TAL_CPUIRQS_CPUIRQS_Pos))
#define TAL_CPUIRQS_MASK            (0x1FFFFFFF) /**< \brief (TAL_CPUIRQS) MASK Register */
