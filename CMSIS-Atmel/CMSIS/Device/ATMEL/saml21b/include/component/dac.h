...
#define DAC_CTRLA_SWRST             ((0x1) << DAC_CTRLA_SWRST_Pos)
#define DAC_CTRLA_ENABLE_Pos        1            /**< \brief (DAC_CTRLA) Enable DAC Controller */
#define DAC_CTRLA_ENABLE            ((0x1) << DAC_CTRLA_ENABLE_Pos)
#define DAC_CTRLA_MASK              (0x03)     /**< \brief (DAC_CTRLA) MASK Register */
...
#define DAC_CTRLB_DIFF              ((0x1) << DAC_CTRLB_DIFF_Pos)
#define DAC_CTRLB_REFSEL_Pos        1            /**< \brief (DAC_CTRLB) Reference Selection for DAC0/1 */
#define DAC_CTRLB_REFSEL_Msk        ((0x3) << DAC_CTRLB_REFSEL_Pos)
#define DAC_CTRLB_REFSEL(value)     (DAC_CTRLB_REFSEL_Msk & ((value) << DAC_CTRLB_REFSEL_Pos))
#define   DAC_CTRLB_REFSEL_VREFPU_Val     (0x0)   /**< \brief (DAC_CTRLB) External reference unbuffered */
#define   DAC_CTRLB_REFSEL_VDDANA_Val     (0x1)   /**< \brief (DAC_CTRLB) Analog supply */
#define   DAC_CTRLB_REFSEL_VREFPB_Val     (0x2)   /**< \brief (DAC_CTRLB) External reference buffered */
#define   DAC_CTRLB_REFSEL_INTREF_Val     (0x3)   /**< \brief (DAC_CTRLB) Internal bandgap reference */
...
#define DAC_CTRLB_MASK              (0x07)     /**< \brief (DAC_CTRLB) MASK Register */
...
#define DAC_EVCTRL_STARTEI_Msk      ((0x3) << DAC_EVCTRL_STARTEI_Pos)
...
#define DAC_EVCTRL_EMPTYEO_Msk      ((0x3) << DAC_EVCTRL_EMPTYEO_Pos)
...
#define DAC_EVCTRL_INVEI_Msk        ((0x3) << DAC_EVCTRL_INVEI_Pos)
#define DAC_EVCTRL_INVEI(value)     (DAC_EVCTRL_INVEI_Msk & ((value) << DAC_EVCTRL_INVEI_Pos))
#define DAC_EVCTRL_MASK             (0x3F)     /**< \brief (DAC_EVCTRL) MASK Register */
...
#define DAC_INTENCLR_UNDERRUN_Msk   ((0x3) << DAC_INTENCLR_UNDERRUN_Pos)
...
#define DAC_INTENCLR_EMPTY_Msk      ((0x3) << DAC_INTENCLR_EMPTY_Pos)
#define DAC_INTENCLR_EMPTY(value)   (DAC_INTENCLR_EMPTY_Msk & ((value) << DAC_INTENCLR_EMPTY_Pos))
#define DAC_INTENCLR_MASK           (0x0F)     /**< \brief (DAC_INTENCLR) MASK Register */
...
#define DAC_INTENSET_UNDERRUN_Msk   ((0x3) << DAC_INTENSET_UNDERRUN_Pos)
...
#define DAC_INTENSET_EMPTY_Msk      ((0x3) << DAC_INTENSET_EMPTY_Pos)
#define DAC_INTENSET_EMPTY(value)   (DAC_INTENSET_EMPTY_Msk & ((value) << DAC_INTENSET_EMPTY_Pos))
#define DAC_INTENSET_MASK           (0x0F)     /**< \brief (DAC_INTENSET) MASK Register */
...
#define DAC_INTFLAG_UNDERRUN_Msk    ((0x3) << DAC_INTFLAG_UNDERRUN_Pos)
...
#define DAC_INTFLAG_EMPTY_Msk       ((0x3) << DAC_INTFLAG_EMPTY_Pos)
#define DAC_INTFLAG_EMPTY(value)    (DAC_INTFLAG_EMPTY_Msk & ((value) << DAC_INTFLAG_EMPTY_Pos))
#define DAC_INTFLAG_MASK            (0x0F)     /**< \brief (DAC_INTFLAG) MASK Register */
...
#define DAC_STATUS_READY_Msk        ((0x3) << DAC_STATUS_READY_Pos)
...
#define DAC_STATUS_EOC_Msk          ((0x3) << DAC_STATUS_EOC_Pos)
#define DAC_STATUS_EOC(value)       (DAC_STATUS_EOC_Msk & ((value) << DAC_STATUS_EOC_Pos))
#define DAC_STATUS_MASK             (0x0F)     /**< \brief (DAC_STATUS) MASK Register */
...
#define DAC_SYNCBUSY_SWRST          ((0x1) << DAC_SYNCBUSY_SWRST_Pos)
#define DAC_SYNCBUSY_ENABLE_Pos     1            /**< \brief (DAC_SYNCBUSY) DAC Enable Status */
#define DAC_SYNCBUSY_ENABLE         ((0x1) << DAC_SYNCBUSY_ENABLE_Pos)
...
#define DAC_SYNCBUSY_DATA_Msk       ((0x3) << DAC_SYNCBUSY_DATA_Pos)
...
#define DAC_SYNCBUSY_DATABUF_Msk    ((0x3) << DAC_SYNCBUSY_DATABUF_Pos)
#define DAC_SYNCBUSY_DATABUF(value) (DAC_SYNCBUSY_DATABUF_Msk & ((value) << DAC_SYNCBUSY_DATABUF_Pos))
#define DAC_SYNCBUSY_MASK           (0x0000003F) /**< \brief (DAC_SYNCBUSY) MASK Register */
...
#define DAC_DACCTRL_RESETVALUE      (0x0000);  /**< \brief (DAC_DACCTRL reset_value) DAC n Control */

#define DAC_DACCTRL_LEFTADJ_Pos     0            /**< \brief (DAC_DACCTRL) Left Adjusted Data */
#define DAC_DACCTRL_LEFTADJ         ((0x1) << DAC_DACCTRL_LEFTADJ_Pos)
#define DAC_DACCTRL_ENABLE_Pos      1            /**< \brief (DAC_DACCTRL) Enable DAC0 */
#define DAC_DACCTRL_ENABLE          ((0x1) << DAC_DACCTRL_ENABLE_Pos)
#define DAC_DACCTRL_CCTRL_Pos       2            /**< \brief (DAC_DACCTRL) Current Control */
#define DAC_DACCTRL_CCTRL_Msk       ((0x3) << DAC_DACCTRL_CCTRL_Pos)
#define DAC_DACCTRL_CCTRL(value)    (DAC_DACCTRL_CCTRL_Msk & ((value) << DAC_DACCTRL_CCTRL_Pos))
#define   DAC_DACCTRL_CCTRL_CC12M_Val     (0x0)   /**< \brief (DAC_DACCTRL) 1MHz<GCLK_DAC<12MHz */
#define   DAC_DACCTRL_CCTRL_CC1M_Val      (0x1)   /**< \brief (DAC_DACCTRL) 100kHz<GCLK_DAC<1MHz */
#define   DAC_DACCTRL_CCTRL_CC100K_Val    (0x2)   /**< \brief (DAC_DACCTRL) 10kHz<GCLK_DAC<100kHz */
#define   DAC_DACCTRL_CCTRL_CC10K_Val     (0x3)   /**< \brief (DAC_DACCTRL) GCLK_DAC<100kHz */
...
#define DAC_DACCTRL_RUNSTDBY        ((0x1) << DAC_DACCTRL_RUNSTDBY_Pos)
#define DAC_DACCTRL_DITHER_Pos      7            /**< \brief (DAC_DACCTRL) Dithering Mode */
#define DAC_DACCTRL_DITHER          ((0x1) << DAC_DACCTRL_DITHER_Pos)
#define DAC_DACCTRL_REFRESH_Pos     8            /**< \brief (DAC_DACCTRL) Refresh period */
#define DAC_DACCTRL_REFRESH_Msk     ((0xF) << DAC_DACCTRL_REFRESH_Pos)
#define DAC_DACCTRL_REFRESH(value)  (DAC_DACCTRL_REFRESH_Msk & ((value) << DAC_DACCTRL_REFRESH_Pos))
#define DAC_DACCTRL_MASK            (0x0FCF)   /**< \brief (DAC_DACCTRL) MASK Register */
...
#define DAC_DATA_RESETVALUE         (0x0000);  /**< \brief (DAC_DATA reset_value) DAC n Data */

#define DAC_DATA_DATA_Pos           0            /**< \brief (DAC_DATA) DAC0 Data */
#define DAC_DATA_DATA_Msk           ((0xFFFF) << DAC_DATA_DATA_Pos)
#define DAC_DATA_DATA(value)        (DAC_DATA_DATA_Msk & ((value) << DAC_DATA_DATA_Pos))
#define DAC_DATA_MASK               (0xFFFF)   /**< \brief (DAC_DATA) MASK Register */
...
#define DAC_DATABUF_RESETVALUE      (0x0000);  /**< \brief (DAC_DATABUF reset_value) DAC n Data Buffer */

#define DAC_DATABUF_DATABUF_Pos     0            /**< \brief (DAC_DATABUF) DAC0 Data Buffer */
#define DAC_DATABUF_DATABUF_Msk     ((0xFFFF) << DAC_DATABUF_DATABUF_Pos)
#define DAC_DATABUF_DATABUF(value)  (DAC_DATABUF_DATABUF_Msk & ((value) << DAC_DATABUF_DATABUF_Pos))
#define DAC_DATABUF_MASK            (0xFFFF)   /**< \brief (DAC_DATABUF) MASK Register */
...
#define DAC_DBGCTRL_DBGRUN          ((0x1) << DAC_DBGCTRL_DBGRUN_Pos)
#define DAC_DBGCTRL_MASK            (0x01)     /**< \brief (DAC_DBGCTRL) MASK Register */
