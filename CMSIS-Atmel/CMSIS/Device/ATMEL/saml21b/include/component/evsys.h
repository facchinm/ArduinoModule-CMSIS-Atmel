...
#define EVSYS_CTRLA_SWRST           ((0x1) << EVSYS_CTRLA_SWRST_Pos)
#define EVSYS_CTRLA_MASK            (0x01)     /**< \brief (EVSYS_CTRLA) MASK Register */
...
#define EVSYS_CHSTATUS_USRRDY_Msk   ((0xFFF) << EVSYS_CHSTATUS_USRRDY_Pos)
...
#define EVSYS_CHSTATUS_CHBUSY_Msk   ((0xFFF) << EVSYS_CHSTATUS_CHBUSY_Pos)
#define EVSYS_CHSTATUS_CHBUSY(value) (EVSYS_CHSTATUS_CHBUSY_Msk & ((value) << EVSYS_CHSTATUS_CHBUSY_Pos))
#define EVSYS_CHSTATUS_MASK         (0x0FFF0FFF) /**< \brief (EVSYS_CHSTATUS) MASK Register */
...
#define EVSYS_INTENCLR_OVR_Msk      ((0xFFF) << EVSYS_INTENCLR_OVR_Pos)
...
#define EVSYS_INTENCLR_EVD_Msk      ((0xFFF) << EVSYS_INTENCLR_EVD_Pos)
#define EVSYS_INTENCLR_EVD(value)   (EVSYS_INTENCLR_EVD_Msk & ((value) << EVSYS_INTENCLR_EVD_Pos))
#define EVSYS_INTENCLR_MASK         (0x0FFF0FFF) /**< \brief (EVSYS_INTENCLR) MASK Register */
...
#define EVSYS_INTENSET_OVR_Msk      ((0xFFF) << EVSYS_INTENSET_OVR_Pos)
...
#define EVSYS_INTENSET_EVD_Msk      ((0xFFF) << EVSYS_INTENSET_EVD_Pos)
#define EVSYS_INTENSET_EVD(value)   (EVSYS_INTENSET_EVD_Msk & ((value) << EVSYS_INTENSET_EVD_Pos))
#define EVSYS_INTENSET_MASK         (0x0FFF0FFF) /**< \brief (EVSYS_INTENSET) MASK Register */
...
#define EVSYS_INTFLAG_OVR_Msk       ((0xFFF) << EVSYS_INTFLAG_OVR_Pos)
...
#define EVSYS_INTFLAG_EVD_Msk       ((0xFFF) << EVSYS_INTFLAG_EVD_Pos)
#define EVSYS_INTFLAG_EVD(value)    (EVSYS_INTFLAG_EVD_Msk & ((value) << EVSYS_INTFLAG_EVD_Pos))
#define EVSYS_INTFLAG_MASK          (0x0FFF0FFF) /**< \brief (EVSYS_INTFLAG) MASK Register */
...
#define EVSYS_SWEVT_CHANNEL_Msk     ((0xFFF) << EVSYS_SWEVT_CHANNEL_Pos)
#define EVSYS_SWEVT_CHANNEL(value)  (EVSYS_SWEVT_CHANNEL_Msk & ((value) << EVSYS_SWEVT_CHANNEL_Pos))
#define EVSYS_SWEVT_MASK            (0x00000FFF) /**< \brief (EVSYS_SWEVT) MASK Register */
...
#define EVSYS_CHANNEL_EVGEN_Msk     ((0x7F) << EVSYS_CHANNEL_EVGEN_Pos)
#define EVSYS_CHANNEL_EVGEN(value)  (EVSYS_CHANNEL_EVGEN_Msk & ((value) << EVSYS_CHANNEL_EVGEN_Pos))
#define EVSYS_CHANNEL_PATH_Pos      8            /**< \brief (EVSYS_CHANNEL) Path Selection */
#define EVSYS_CHANNEL_PATH_Msk      ((0x3) << EVSYS_CHANNEL_PATH_Pos)
#define EVSYS_CHANNEL_PATH(value)   (EVSYS_CHANNEL_PATH_Msk & ((value) << EVSYS_CHANNEL_PATH_Pos))
#define   EVSYS_CHANNEL_PATH_SYNCHRONOUS_Val (0x0)   /**< \brief (EVSYS_CHANNEL) Synchronous path */
#define   EVSYS_CHANNEL_PATH_RESYNCHRONIZED_Val (0x1)   /**< \brief (EVSYS_CHANNEL) Resynchronized path */
#define   EVSYS_CHANNEL_PATH_ASYNCHRONOUS_Val (0x2)   /**< \brief (EVSYS_CHANNEL) Asynchronous path */
...
#define EVSYS_CHANNEL_EDGSEL_Msk    ((0x3) << EVSYS_CHANNEL_EDGSEL_Pos)
#define EVSYS_CHANNEL_EDGSEL(value) (EVSYS_CHANNEL_EDGSEL_Msk & ((value) << EVSYS_CHANNEL_EDGSEL_Pos))
#define   EVSYS_CHANNEL_EDGSEL_NO_EVT_OUTPUT_Val (0x0)   /**< \brief (EVSYS_CHANNEL) No event output when using the resynchronized or synchronous path */
#define   EVSYS_CHANNEL_EDGSEL_RISING_EDGE_Val (0x1)   /**< \brief (EVSYS_CHANNEL) Event detection only on the rising edge of the signal from the event generator when using the resynchronized or synchronous path */
#define   EVSYS_CHANNEL_EDGSEL_FALLING_EDGE_Val (0x2)   /**< \brief (EVSYS_CHANNEL) Event detection only on the falling edge of the signal from the event generator when using the resynchronized or synchronous path */
#define   EVSYS_CHANNEL_EDGSEL_BOTH_EDGES_Val (0x3)   /**< \brief (EVSYS_CHANNEL) Event detection on rising and falling edges of the signal from the event generator when using the resynchronized or synchronous path */
...
#define EVSYS_CHANNEL_RUNSTDBY      ((0x1) << EVSYS_CHANNEL_RUNSTDBY_Pos)
#define EVSYS_CHANNEL_ONDEMAND_Pos  15           /**< \brief (EVSYS_CHANNEL) Generic Clock On Demand */
#define EVSYS_CHANNEL_ONDEMAND      ((0x1) << EVSYS_CHANNEL_ONDEMAND_Pos)
#define EVSYS_CHANNEL_MASK          (0x0000CF7F) /**< \brief (EVSYS_CHANNEL) MASK Register */
...
#define EVSYS_USER_CHANNEL_Msk      ((0x1F) << EVSYS_USER_CHANNEL_Pos)
#define EVSYS_USER_CHANNEL(value)   (EVSYS_USER_CHANNEL_Msk & ((value) << EVSYS_USER_CHANNEL_Pos))
#define EVSYS_USER_MASK             (0x0000001F) /**< \brief (EVSYS_USER) MASK Register */
