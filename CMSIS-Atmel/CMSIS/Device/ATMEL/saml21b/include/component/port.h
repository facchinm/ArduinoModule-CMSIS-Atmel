...
#define PORT_DIR_MASK               (0xFFFFFFFF) /**< \brief (PORT_DIR) MASK Register */
...
#define PORT_DIRCLR_MASK            (0xFFFFFFFF) /**< \brief (PORT_DIRCLR) MASK Register */
...
#define PORT_DIRSET_MASK            (0xFFFFFFFF) /**< \brief (PORT_DIRSET) MASK Register */
...
#define PORT_DIRTGL_MASK            (0xFFFFFFFF) /**< \brief (PORT_DIRTGL) MASK Register */
...
#define PORT_OUT_MASK               (0xFFFFFFFF) /**< \brief (PORT_OUT) MASK Register */
...
#define PORT_OUTCLR_MASK            (0xFFFFFFFF) /**< \brief (PORT_OUTCLR) MASK Register */
...
#define PORT_OUTSET_MASK            (0xFFFFFFFF) /**< \brief (PORT_OUTSET) MASK Register */
...
#define PORT_OUTTGL_MASK            (0xFFFFFFFF) /**< \brief (PORT_OUTTGL) MASK Register */
...
#define PORT_IN_MASK                (0xFFFFFFFF) /**< \brief (PORT_IN) MASK Register */
...
#define PORT_CTRL_SAMPLING_Msk      ((0xFFFFFFFF) << PORT_CTRL_SAMPLING_Pos)
#define PORT_CTRL_SAMPLING(value)   (PORT_CTRL_SAMPLING_Msk & ((value) << PORT_CTRL_SAMPLING_Pos))
#define PORT_CTRL_MASK              (0xFFFFFFFF) /**< \brief (PORT_CTRL) MASK Register */
...
#define PORT_WRCONFIG_PINMASK_Msk   ((0xFFFF) << PORT_WRCONFIG_PINMASK_Pos)
#define PORT_WRCONFIG_PINMASK(value) (PORT_WRCONFIG_PINMASK_Msk & ((value) << PORT_WRCONFIG_PINMASK_Pos))
#define PORT_WRCONFIG_PMUXEN_Pos    16           /**< \brief (PORT_WRCONFIG) Select Peripheral Multiplexer */
#define PORT_WRCONFIG_PMUXEN        ((0x1) << PORT_WRCONFIG_PMUXEN_Pos)
#define PORT_WRCONFIG_INEN_Pos      17           /**< \brief (PORT_WRCONFIG) Input Enable */
#define PORT_WRCONFIG_INEN          ((0x1) << PORT_WRCONFIG_INEN_Pos)
#define PORT_WRCONFIG_PULLEN_Pos    18           /**< \brief (PORT_WRCONFIG) Pull Enable */
#define PORT_WRCONFIG_PULLEN        ((0x1) << PORT_WRCONFIG_PULLEN_Pos)
#define PORT_WRCONFIG_DRVSTR_Pos    22           /**< \brief (PORT_WRCONFIG) Output Driver Strength Selection */
#define PORT_WRCONFIG_DRVSTR        ((0x1) << PORT_WRCONFIG_DRVSTR_Pos)
...
#define PORT_WRCONFIG_WRPMUX        ((0x1) << PORT_WRCONFIG_WRPMUX_Pos)
#define PORT_WRCONFIG_WRPINCFG_Pos  30           /**< \brief (PORT_WRCONFIG) Write PINCFG Registers */
#define PORT_WRCONFIG_WRPINCFG      ((0x1) << PORT_WRCONFIG_WRPINCFG_Pos)
#define PORT_WRCONFIG_HWSEL_Pos     31           /**< \brief (PORT_WRCONFIG) Half-Word Select */
#define PORT_WRCONFIG_HWSEL         ((0x1) << PORT_WRCONFIG_HWSEL_Pos)
#define PORT_WRCONFIG_MASK          (0xDF47FFFF) /**< \brief (PORT_WRCONFIG) MASK Register */
...
#define PORT_EVCTRL_PID0_Msk        ((0x1F) << PORT_EVCTRL_PID0_Pos)
...
#define PORT_EVCTRL_EVACT0_Msk      ((0x3) << PORT_EVCTRL_EVACT0_Pos)
...
#define PORT_EVCTRL_PORTEI0         ((0x1) << PORT_EVCTRL_PORTEI0_Pos)
#define PORT_EVCTRL_PID1_Pos        8            /**< \brief (PORT_EVCTRL) Port Event Pin Identifier 1 */
#define PORT_EVCTRL_PID1_Msk        ((0x1F) << PORT_EVCTRL_PID1_Pos)
...
#define PORT_EVCTRL_EVACT1_Msk      ((0x3) << PORT_EVCTRL_EVACT1_Pos)
...
#define PORT_EVCTRL_PORTEI1         ((0x1) << PORT_EVCTRL_PORTEI1_Pos)
#define PORT_EVCTRL_PID2_Pos        16           /**< \brief (PORT_EVCTRL) Port Event Pin Identifier 2 */
#define PORT_EVCTRL_PID2_Msk        ((0x1F) << PORT_EVCTRL_PID2_Pos)
...
#define PORT_EVCTRL_EVACT2_Msk      ((0x3) << PORT_EVCTRL_EVACT2_Pos)
...
#define PORT_EVCTRL_PORTEI2         ((0x1) << PORT_EVCTRL_PORTEI2_Pos)
#define PORT_EVCTRL_PID3_Pos        24           /**< \brief (PORT_EVCTRL) Port Event Pin Identifier 3 */
#define PORT_EVCTRL_PID3_Msk        ((0x1F) << PORT_EVCTRL_PID3_Pos)
...
#define PORT_EVCTRL_EVACT3_Msk      ((0x3) << PORT_EVCTRL_EVACT3_Pos)
...
#define PORT_EVCTRL_PORTEI3         ((0x1) << PORT_EVCTRL_PORTEI3_Pos)
#define PORT_EVCTRL_MASK            (0xFFFFFFFF) /**< \brief (PORT_EVCTRL) MASK Register */
...
#define PORT_PMUX_PMUXE_Msk         ((0xF) << PORT_PMUX_PMUXE_Pos)
#define PORT_PMUX_PMUXE(value)      (PORT_PMUX_PMUXE_Msk & ((value) << PORT_PMUX_PMUXE_Pos))
#define PORT_PMUX_PMUXO_Pos         4            /**< \brief (PORT_PMUX) Peripheral Multiplexing for Odd-Numbered Pin */
#define PORT_PMUX_PMUXO_Msk         ((0xF) << PORT_PMUX_PMUXO_Pos)
#define PORT_PMUX_PMUXO(value)      (PORT_PMUX_PMUXO_Msk & ((value) << PORT_PMUX_PMUXO_Pos))
#define PORT_PMUX_MASK              (0xFF)     /**< \brief (PORT_PMUX) MASK Register */
...
#define PORT_PINCFG_PMUXEN          ((0x1) << PORT_PINCFG_PMUXEN_Pos)
#define PORT_PINCFG_INEN_Pos        1            /**< \brief (PORT_PINCFG) Input Enable */
#define PORT_PINCFG_INEN            ((0x1) << PORT_PINCFG_INEN_Pos)
#define PORT_PINCFG_PULLEN_Pos      2            /**< \brief (PORT_PINCFG) Pull Enable */
#define PORT_PINCFG_PULLEN          ((0x1) << PORT_PINCFG_PULLEN_Pos)
#define PORT_PINCFG_DRVSTR_Pos      6            /**< \brief (PORT_PINCFG) Output Driver Strength Selection */
#define PORT_PINCFG_DRVSTR          ((0x1) << PORT_PINCFG_DRVSTR_Pos)
#define PORT_PINCFG_MASK            (0x47)     /**< \brief (PORT_PINCFG) MASK Register */
