...
#define TRNG_CTRLA_ENABLE           ((0x1) << TRNG_CTRLA_ENABLE_Pos)
#define TRNG_CTRLA_RUNSTDBY_Pos     6            /**< \brief (TRNG_CTRLA) Run in Standby */
#define TRNG_CTRLA_RUNSTDBY         ((0x1) << TRNG_CTRLA_RUNSTDBY_Pos)
#define TRNG_CTRLA_MASK             (0x42)     /**< \brief (TRNG_CTRLA) MASK Register */
...
#define TRNG_EVCTRL_DATARDYEO       ((0x1) << TRNG_EVCTRL_DATARDYEO_Pos)
#define TRNG_EVCTRL_MASK            (0x01)     /**< \brief (TRNG_EVCTRL) MASK Register */
...
#define TRNG_INTENCLR_DATARDY       ((0x1) << TRNG_INTENCLR_DATARDY_Pos)
#define TRNG_INTENCLR_MASK          (0x01)     /**< \brief (TRNG_INTENCLR) MASK Register */
...
#define TRNG_INTENSET_DATARDY       ((0x1) << TRNG_INTENSET_DATARDY_Pos)
#define TRNG_INTENSET_MASK          (0x01)     /**< \brief (TRNG_INTENSET) MASK Register */
...
#define TRNG_INTFLAG_DATARDY        ((0x1) << TRNG_INTFLAG_DATARDY_Pos)
#define TRNG_INTFLAG_MASK           (0x01)     /**< \brief (TRNG_INTFLAG) MASK Register */
...
#define TRNG_DATA_DATA_Msk          ((0xFFFFFFFF) << TRNG_DATA_DATA_Pos)
#define TRNG_DATA_DATA(value)       (TRNG_DATA_DATA_Msk & ((value) << TRNG_DATA_DATA_Pos))
#define TRNG_DATA_MASK              (0xFFFFFFFF) /**< \brief (TRNG_DATA) MASK Register */
