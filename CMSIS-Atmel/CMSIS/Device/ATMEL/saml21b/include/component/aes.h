...
#define AES_CTRLA_SWRST             ((0x1) << AES_CTRLA_SWRST_Pos)
#define AES_CTRLA_ENABLE_Pos        1            /**< \brief (AES_CTRLA) Enable */
#define AES_CTRLA_ENABLE            ((0x1) << AES_CTRLA_ENABLE_Pos)
#define AES_CTRLA_AESMODE_Pos       2            /**< \brief (AES_CTRLA) AES Modes of operation */
#define AES_CTRLA_AESMODE_Msk       ((0x7) << AES_CTRLA_AESMODE_Pos)
...
#define AES_CTRLA_CFBS_Msk          ((0x7) << AES_CTRLA_CFBS_Pos)
...
#define AES_CTRLA_KEYSIZE_Msk       ((0x3) << AES_CTRLA_KEYSIZE_Pos)
...
#define AES_CTRLB_START             ((0x1) << AES_CTRLB_START_Pos)
#define AES_CTRLB_NEWMSG_Pos        1            /**< \brief (AES_CTRLB) New message */
#define AES_CTRLB_NEWMSG            ((0x1) << AES_CTRLB_NEWMSG_Pos)
#define AES_CTRLB_EOM_Pos           2            /**< \brief (AES_CTRLB) End of message */
#define AES_CTRLB_EOM               ((0x1) << AES_CTRLB_EOM_Pos)
#define AES_CTRLB_GFMUL_Pos         3            /**< \brief (AES_CTRLB) GF Multiplication */
#define AES_CTRLB_GFMUL             ((0x1) << AES_CTRLB_GFMUL_Pos)
#define AES_CTRLB_MASK              (0x0F)     /**< \brief (AES_CTRLB) MASK Register */
...
#define AES_INTENCLR_ENCCMP         ((0x1) << AES_INTENCLR_ENCCMP_Pos)
#define AES_INTENCLR_GFMCMP_Pos     1            /**< \brief (AES_INTENCLR) GF Multiplication Complete */
#define AES_INTENCLR_GFMCMP         ((0x1) << AES_INTENCLR_GFMCMP_Pos)
#define AES_INTENCLR_MASK           (0x03)     /**< \brief (AES_INTENCLR) MASK Register */
...
#define AES_INTENSET_ENCCMP         ((0x1) << AES_INTENSET_ENCCMP_Pos)
#define AES_INTENSET_GFMCMP_Pos     1            /**< \brief (AES_INTENSET) GF Multiplication Complete */
#define AES_INTENSET_GFMCMP         ((0x1) << AES_INTENSET_GFMCMP_Pos)
#define AES_INTENSET_MASK           (0x03)     /**< \brief (AES_INTENSET) MASK Register */
...
#define AES_INTFLAG_ENCCMP          ((0x1) << AES_INTFLAG_ENCCMP_Pos)
#define AES_INTFLAG_GFMCMP_Pos      1            /**< \brief (AES_INTFLAG) GF Multiplication Complete */
#define AES_INTFLAG_GFMCMP          ((0x1) << AES_INTFLAG_GFMCMP_Pos)
#define AES_INTFLAG_MASK            (0x03)     /**< \brief (AES_INTFLAG) MASK Register */
...
#define AES_DATABUFPTR_INDATAPTR_Msk ((0x3) << AES_DATABUFPTR_INDATAPTR_Pos)
#define AES_DATABUFPTR_INDATAPTR(value) (AES_DATABUFPTR_INDATAPTR_Msk & ((value) << AES_DATABUFPTR_INDATAPTR_Pos))
#define AES_DATABUFPTR_MASK         (0x03)     /**< \brief (AES_DATABUFPTR) MASK Register */
...
#define AES_DBGCTRL_DBGRUN          ((0x1) << AES_DBGCTRL_DBGRUN_Pos)
#define AES_DBGCTRL_MASK            (0x01)     /**< \brief (AES_DBGCTRL) MASK Register */
...
#define AES_KEYWORD_RESETVALUE      (0x00000000); /**< \brief (AES_KEYWORD reset_value) Keyword n */
#define AES_KEYWORD_MASK            (0xFFFFFFFF) /**< \brief (AES_KEYWORD) MASK Register */
...
#define AES_INDATA_MASK             (0xFFFFFFFF) /**< \brief (AES_INDATA) MASK Register */
...
#define AES_INTVECTV_RESETVALUE     (0x00000000); /**< \brief (AES_INTVECTV reset_value) Initialisation Vector n */
#define AES_INTVECTV_MASK           (0xFFFFFFFF) /**< \brief (AES_INTVECTV) MASK Register */
...
#define AES_HASHKEY_RESETVALUE      (0x00000000); /**< \brief (AES_HASHKEY reset_value) Hash key n */
#define AES_HASHKEY_MASK            (0xFFFFFFFF) /**< \brief (AES_HASHKEY) MASK Register */
...
#define AES_GHASH_RESETVALUE        (0x00000000); /**< \brief (AES_GHASH reset_value) Galois Hash n */
#define AES_GHASH_MASK              (0xFFFFFFFF) /**< \brief (AES_GHASH) MASK Register */
...
#define AES_CIPLEN_MASK             (0xFFFFFFFF) /**< \brief (AES_CIPLEN) MASK Register */
...
#define AES_RANDSEED_MASK           (0xFFFFFFFF) /**< \brief (AES_RANDSEED) MASK Register */
