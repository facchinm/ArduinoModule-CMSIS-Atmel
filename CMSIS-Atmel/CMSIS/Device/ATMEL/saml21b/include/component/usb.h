...
#define USB_CTRLA_SWRST             ((0x1) << USB_CTRLA_SWRST_Pos)
#define USB_CTRLA_ENABLE_Pos        1            /**< \brief (USB_CTRLA) Enable */
#define USB_CTRLA_ENABLE            ((0x1) << USB_CTRLA_ENABLE_Pos)
#define USB_CTRLA_RUNSTDBY_Pos      2            /**< \brief (USB_CTRLA) Run in Standby Mode */
#define USB_CTRLA_RUNSTDBY          ((0x1) << USB_CTRLA_RUNSTDBY_Pos)
#define USB_CTRLA_MODE_Pos          7            /**< \brief (USB_CTRLA) Operating Mode */
#define USB_CTRLA_MODE              ((0x1) << USB_CTRLA_MODE_Pos)
#define   USB_CTRLA_MODE_DEVICE_Val       (0x0)   /**< \brief (USB_CTRLA) Device Mode */
#define   USB_CTRLA_MODE_HOST_Val         (0x1)   /**< \brief (USB_CTRLA) Host Mode */
...
#define USB_CTRLA_MASK              (0x87)     /**< \brief (USB_CTRLA) MASK Register */
...
#define USB_SYNCBUSY_SWRST          ((0x1) << USB_SYNCBUSY_SWRST_Pos)
#define USB_SYNCBUSY_ENABLE_Pos     1            /**< \brief (USB_SYNCBUSY) Enable Synchronization Busy */
#define USB_SYNCBUSY_ENABLE         ((0x1) << USB_SYNCBUSY_ENABLE_Pos)
#define USB_SYNCBUSY_MASK           (0x03)     /**< \brief (USB_SYNCBUSY) MASK Register */
...
#define USB_QOSCTRL_RESETVALUE      (0x0F);    /**< \brief (USB_QOSCTRL reset_value) USB Quality Of Service */

#define USB_QOSCTRL_CQOS_Pos        0            /**< \brief (USB_QOSCTRL) Configuration Quality of Service */
#define USB_QOSCTRL_CQOS_Msk        ((0x3) << USB_QOSCTRL_CQOS_Pos)
...
#define USB_QOSCTRL_DQOS_Msk        ((0x3) << USB_QOSCTRL_DQOS_Pos)
#define USB_QOSCTRL_DQOS(value)     (USB_QOSCTRL_DQOS_Msk & ((value) << USB_QOSCTRL_DQOS_Pos))
#define USB_QOSCTRL_MASK            (0x0F)     /**< \brief (USB_QOSCTRL) MASK Register */
...
#define USB_DEVICE_CTRLB_DETACH     ((0x1) << USB_DEVICE_CTRLB_DETACH_Pos)
#define USB_DEVICE_CTRLB_UPRSM_Pos  1            /**< \brief (USB_DEVICE_CTRLB) Upstream Resume */
#define USB_DEVICE_CTRLB_UPRSM      ((0x1) << USB_DEVICE_CTRLB_UPRSM_Pos)
#define USB_DEVICE_CTRLB_SPDCONF_Pos 2            /**< \brief (USB_DEVICE_CTRLB) Speed Configuration */
#define USB_DEVICE_CTRLB_SPDCONF_Msk ((0x3) << USB_DEVICE_CTRLB_SPDCONF_Pos)
#define USB_DEVICE_CTRLB_SPDCONF(value) (USB_DEVICE_CTRLB_SPDCONF_Msk & ((value) << USB_DEVICE_CTRLB_SPDCONF_Pos))
#define   USB_DEVICE_CTRLB_SPDCONF_FS_Val (0x0)   /**< \brief (USB_DEVICE_CTRLB) FS : Full Speed */
#define   USB_DEVICE_CTRLB_SPDCONF_LS_Val (0x1)   /**< \brief (USB_DEVICE_CTRLB) LS : Low Speed */
#define   USB_DEVICE_CTRLB_SPDCONF_HS_Val (0x2)   /**< \brief (USB_DEVICE_CTRLB) HS : High Speed capable */
#define   USB_DEVICE_CTRLB_SPDCONF_HSTM_Val (0x3)   /**< \brief (USB_DEVICE_CTRLB) HSTM: High Speed Test Mode (force high-speed mode for test mode) */
...
#define USB_DEVICE_CTRLB_NREPLY     ((0x1) << USB_DEVICE_CTRLB_NREPLY_Pos)
#define USB_DEVICE_CTRLB_TSTJ_Pos   5            /**< \brief (USB_DEVICE_CTRLB) Test mode J */
#define USB_DEVICE_CTRLB_TSTJ       ((0x1) << USB_DEVICE_CTRLB_TSTJ_Pos)
#define USB_DEVICE_CTRLB_TSTK_Pos   6            /**< \brief (USB_DEVICE_CTRLB) Test mode K */
#define USB_DEVICE_CTRLB_TSTK       ((0x1) << USB_DEVICE_CTRLB_TSTK_Pos)
#define USB_DEVICE_CTRLB_TSTPCKT_Pos 7            /**< \brief (USB_DEVICE_CTRLB) Test packet mode */
#define USB_DEVICE_CTRLB_TSTPCKT    ((0x1) << USB_DEVICE_CTRLB_TSTPCKT_Pos)
#define USB_DEVICE_CTRLB_OPMODE2_Pos 8            /**< \brief (USB_DEVICE_CTRLB) Specific Operational Mode */
#define USB_DEVICE_CTRLB_OPMODE2    ((0x1) << USB_DEVICE_CTRLB_OPMODE2_Pos)
#define USB_DEVICE_CTRLB_GNAK_Pos   9            /**< \brief (USB_DEVICE_CTRLB) Global NAK */
#define USB_DEVICE_CTRLB_GNAK       ((0x1) << USB_DEVICE_CTRLB_GNAK_Pos)
#define USB_DEVICE_CTRLB_LPMHDSK_Pos 10           /**< \brief (USB_DEVICE_CTRLB) Link Power Management Handshake */
#define USB_DEVICE_CTRLB_LPMHDSK_Msk ((0x3) << USB_DEVICE_CTRLB_LPMHDSK_Pos)
#define USB_DEVICE_CTRLB_LPMHDSK(value) (USB_DEVICE_CTRLB_LPMHDSK_Msk & ((value) << USB_DEVICE_CTRLB_LPMHDSK_Pos))
#define   USB_DEVICE_CTRLB_LPMHDSK_NO_Val (0x0)   /**< \brief (USB_DEVICE_CTRLB) No handshake. LPM is not supported */
#define   USB_DEVICE_CTRLB_LPMHDSK_ACK_Val (0x1)   /**< \brief (USB_DEVICE_CTRLB) ACK */
#define   USB_DEVICE_CTRLB_LPMHDSK_NYET_Val (0x2)   /**< \brief (USB_DEVICE_CTRLB) NYET */
#define   USB_DEVICE_CTRLB_LPMHDSK_STALL_Val (0x3)   /**< \brief (USB_DEVICE_CTRLB) STALL */
...
#define USB_DEVICE_CTRLB_MASK       (0x0FFF)   /**< \brief (USB_DEVICE_CTRLB) MASK Register */
...
#define USB_HOST_CTRLB_RESUME       ((0x1) << USB_HOST_CTRLB_RESUME_Pos)
#define USB_HOST_CTRLB_SPDCONF_Pos  2            /**< \brief (USB_HOST_CTRLB) Speed Configuration for Host */
#define USB_HOST_CTRLB_SPDCONF_Msk  ((0x3) << USB_HOST_CTRLB_SPDCONF_Pos)
#define USB_HOST_CTRLB_SPDCONF(value) (USB_HOST_CTRLB_SPDCONF_Msk & ((value) << USB_HOST_CTRLB_SPDCONF_Pos))
#define   USB_HOST_CTRLB_SPDCONF_NORMAL_Val (0x0)   /**< \brief (USB_HOST_CTRLB) Normal mode: the host starts in full-speed mode and performs a high-speed reset to switch to the high speed mode if the downstream peripheral is high-speed capable. */
#define   USB_HOST_CTRLB_SPDCONF_FS_Val   (0x3)   /**< \brief (USB_HOST_CTRLB) Full-speed: the host remains in full-speed mode whatever is the peripheral speed capability. Relevant in UTMI mode only. */
...
#define USB_HOST_CTRLB_AUTORESUME   ((0x1) << USB_HOST_CTRLB_AUTORESUME_Pos)
#define USB_HOST_CTRLB_TSTJ_Pos     5            /**< \brief (USB_HOST_CTRLB) Test mode J */
#define USB_HOST_CTRLB_TSTJ         ((0x1) << USB_HOST_CTRLB_TSTJ_Pos)
#define USB_HOST_CTRLB_TSTK_Pos     6            /**< \brief (USB_HOST_CTRLB) Test mode K */
#define USB_HOST_CTRLB_TSTK         ((0x1) << USB_HOST_CTRLB_TSTK_Pos)
#define USB_HOST_CTRLB_SOFE_Pos     8            /**< \brief (USB_HOST_CTRLB) Start of Frame Generation Enable */
#define USB_HOST_CTRLB_SOFE         ((0x1) << USB_HOST_CTRLB_SOFE_Pos)
#define USB_HOST_CTRLB_BUSRESET_Pos 9            /**< \brief (USB_HOST_CTRLB) Send USB Reset */
#define USB_HOST_CTRLB_BUSRESET     ((0x1) << USB_HOST_CTRLB_BUSRESET_Pos)
#define USB_HOST_CTRLB_VBUSOK_Pos   10           /**< \brief (USB_HOST_CTRLB) VBUS is OK */
#define USB_HOST_CTRLB_VBUSOK       ((0x1) << USB_HOST_CTRLB_VBUSOK_Pos)
#define USB_HOST_CTRLB_L1RESUME_Pos 11           /**< \brief (USB_HOST_CTRLB) Send L1 Resume */
#define USB_HOST_CTRLB_L1RESUME     ((0x1) << USB_HOST_CTRLB_L1RESUME_Pos)
#define USB_HOST_CTRLB_MASK         (0x0F7E)   /**< \brief (USB_HOST_CTRLB) MASK Register */
...
#define USB_DEVICE_DADD_DADD_Msk    ((0x7F) << USB_DEVICE_DADD_DADD_Pos)
...
#define USB_DEVICE_DADD_ADDEN       ((0x1) << USB_DEVICE_DADD_ADDEN_Pos)
#define USB_DEVICE_DADD_MASK        (0xFF)     /**< \brief (USB_DEVICE_DADD) MASK Register */
...
#define USB_HOST_HSOFC_FLENC_Msk    ((0xF) << USB_HOST_HSOFC_FLENC_Pos)
...
#define USB_HOST_HSOFC_FLENCE       ((0x1) << USB_HOST_HSOFC_FLENCE_Pos)
#define USB_HOST_HSOFC_MASK         (0x8F)     /**< \brief (USB_HOST_HSOFC) MASK Register */
...
#define USB_DEVICE_STATUS_SPEED_Msk ((0x3) << USB_DEVICE_STATUS_SPEED_Pos)
#define USB_DEVICE_STATUS_SPEED(value) (USB_DEVICE_STATUS_SPEED_Msk & ((value) << USB_DEVICE_STATUS_SPEED_Pos))
#define   USB_DEVICE_STATUS_SPEED_FS_Val  (0x0)   /**< \brief (USB_DEVICE_STATUS) Full-speed mode */
#define   USB_DEVICE_STATUS_SPEED_HS_Val  (0x1)   /**< \brief (USB_DEVICE_STATUS) High-speed mode */
#define   USB_DEVICE_STATUS_SPEED_LS_Val  (0x2)   /**< \brief (USB_DEVICE_STATUS) Low-speed mode */
...
#define USB_DEVICE_STATUS_LINESTATE_Msk ((0x3) << USB_DEVICE_STATUS_LINESTATE_Pos)
#define USB_DEVICE_STATUS_LINESTATE(value) (USB_DEVICE_STATUS_LINESTATE_Msk & ((value) << USB_DEVICE_STATUS_LINESTATE_Pos))
#define   USB_DEVICE_STATUS_LINESTATE_0_Val (0x0)   /**< \brief (USB_DEVICE_STATUS) SE0/RESET */
#define   USB_DEVICE_STATUS_LINESTATE_1_Val (0x1)   /**< \brief (USB_DEVICE_STATUS) FS-J or LS-K State */
#define   USB_DEVICE_STATUS_LINESTATE_2_Val (0x2)   /**< \brief (USB_DEVICE_STATUS) FS-K or LS-J State */
...
#define USB_DEVICE_STATUS_MASK      (0xCC)     /**< \brief (USB_DEVICE_STATUS) MASK Register */
...
#define USB_HOST_STATUS_SPEED_Msk   ((0x3) << USB_HOST_STATUS_SPEED_Pos)
...
#define USB_HOST_STATUS_LINESTATE_Msk ((0x3) << USB_HOST_STATUS_LINESTATE_Pos)
#define USB_HOST_STATUS_LINESTATE(value) (USB_HOST_STATUS_LINESTATE_Msk & ((value) << USB_HOST_STATUS_LINESTATE_Pos))
#define USB_HOST_STATUS_MASK        (0xCC)     /**< \brief (USB_HOST_STATUS) MASK Register */
...
#define USB_FSMSTATUS_FSMSTATE_Msk  ((0x7F) << USB_FSMSTATUS_FSMSTATE_Pos)
#define USB_FSMSTATUS_FSMSTATE(value) (USB_FSMSTATUS_FSMSTATE_Msk & ((value) << USB_FSMSTATUS_FSMSTATE_Pos))
#define   USB_FSMSTATUS_FSMSTATE_OFF_Val  (0x1)   /**< \brief (USB_FSMSTATUS) OFF (L3). It corresponds to the powered-off, disconnected, and disabled state */
#define   USB_FSMSTATUS_FSMSTATE_ON_Val   (0x2)   /**< \brief (USB_FSMSTATUS) ON (L0). It corresponds to the Idle and Active states */
#define   USB_FSMSTATUS_FSMSTATE_SUSPEND_Val (0x4)   /**< \brief (USB_FSMSTATUS) SUSPEND (L2) */
#define   USB_FSMSTATUS_FSMSTATE_SLEEP_Val (0x8)   /**< \brief (USB_FSMSTATUS) SLEEP (L1) */
#define   USB_FSMSTATUS_FSMSTATE_DNRESUME_Val (0x10)   /**< \brief (USB_FSMSTATUS) DNRESUME. Down Stream Resume. */
#define   USB_FSMSTATUS_FSMSTATE_UPRESUME_Val (0x20)   /**< \brief (USB_FSMSTATUS) UPRESUME. Up Stream Resume. */
#define   USB_FSMSTATUS_FSMSTATE_RESET_Val (0x40)   /**< \brief (USB_FSMSTATUS) RESET. USB lines Reset. */
...
#define USB_FSMSTATUS_MASK          (0x7F)     /**< \brief (USB_FSMSTATUS) MASK Register */
...
#define USB_DEVICE_FNUM_MFNUM_Msk   ((0x7) << USB_DEVICE_FNUM_MFNUM_Pos)
...
#define USB_DEVICE_FNUM_FNUM_Msk    ((0x7FF) << USB_DEVICE_FNUM_FNUM_Pos)
...
#define USB_DEVICE_FNUM_FNCERR      ((0x1) << USB_DEVICE_FNUM_FNCERR_Pos)
#define USB_DEVICE_FNUM_MASK        (0xBFFF)   /**< \brief (USB_DEVICE_FNUM) MASK Register */
...
#define USB_HOST_FNUM_MFNUM_Msk     ((0x7) << USB_HOST_FNUM_MFNUM_Pos)
...
#define USB_HOST_FNUM_FNUM_Msk      ((0x7FF) << USB_HOST_FNUM_FNUM_Pos)
#define USB_HOST_FNUM_FNUM(value)   (USB_HOST_FNUM_FNUM_Msk & ((value) << USB_HOST_FNUM_FNUM_Pos))
#define USB_HOST_FNUM_MASK          (0x3FFF)   /**< \brief (USB_HOST_FNUM) MASK Register */
...
#define USB_HOST_FLENHIGH_FLENHIGH_Msk ((0xFF) << USB_HOST_FLENHIGH_FLENHIGH_Pos)
#define USB_HOST_FLENHIGH_FLENHIGH(value) (USB_HOST_FLENHIGH_FLENHIGH_Msk & ((value) << USB_HOST_FLENHIGH_FLENHIGH_Pos))
#define USB_HOST_FLENHIGH_MASK      (0xFF)     /**< \brief (USB_HOST_FLENHIGH) MASK Register */
...
#define USB_HOST_INTFLAG_HSOF       ((0x1) << USB_HOST_INTFLAG_HSOF_Pos)
#define USB_HOST_INTFLAG_RST_Pos    3            /**< \brief (USB_HOST_INTFLAG) Bus Reset */
#define USB_HOST_INTFLAG_RST        ((0x1) << USB_HOST_INTFLAG_RST_Pos)
#define USB_HOST_INTFLAG_WAKEUP_Pos 4            /**< \brief (USB_HOST_INTFLAG) Wake Up */
#define USB_HOST_INTFLAG_WAKEUP     ((0x1) << USB_HOST_INTFLAG_WAKEUP_Pos)
#define USB_HOST_INTFLAG_DNRSM_Pos  5            /**< \brief (USB_HOST_INTFLAG) Downstream */
#define USB_HOST_INTFLAG_DNRSM      ((0x1) << USB_HOST_INTFLAG_DNRSM_Pos)
#define USB_HOST_INTFLAG_UPRSM_Pos  6            /**< \brief (USB_HOST_INTFLAG) Upstream Resume from the Device */
#define USB_HOST_INTFLAG_UPRSM      ((0x1) << USB_HOST_INTFLAG_UPRSM_Pos)
#define USB_HOST_INTFLAG_RAMACER_Pos 7            /**< \brief (USB_HOST_INTFLAG) Ram Access */
#define USB_HOST_INTFLAG_RAMACER    ((0x1) << USB_HOST_INTFLAG_RAMACER_Pos)
#define USB_HOST_INTFLAG_DCONN_Pos  8            /**< \brief (USB_HOST_INTFLAG) Device Connection */
#define USB_HOST_INTFLAG_DCONN      ((0x1) << USB_HOST_INTFLAG_DCONN_Pos)
#define USB_HOST_INTFLAG_DDISC_Pos  9            /**< \brief (USB_HOST_INTFLAG) Device Disconnection */
#define USB_HOST_INTFLAG_DDISC      ((0x1) << USB_HOST_INTFLAG_DDISC_Pos)
#define USB_HOST_INTFLAG_MASK       (0x03FC)   /**< \brief (USB_HOST_INTFLAG) MASK Register */
...
#define USB_DEVICE_EPINTSMRY_EPINT_Msk ((0xFF) << USB_DEVICE_EPINTSMRY_EPINT_Pos)
#define USB_DEVICE_EPINTSMRY_EPINT(value) (USB_DEVICE_EPINTSMRY_EPINT_Msk & ((value) << USB_DEVICE_EPINTSMRY_EPINT_Pos))
#define USB_DEVICE_EPINTSMRY_MASK   (0x00FF)   /**< \brief (USB_DEVICE_EPINTSMRY) MASK Register */
...
#define USB_HOST_PINTSMRY_EPINT_Msk ((0xFF) << USB_HOST_PINTSMRY_EPINT_Pos)
#define USB_HOST_PINTSMRY_EPINT(value) (USB_HOST_PINTSMRY_EPINT_Msk & ((value) << USB_HOST_PINTSMRY_EPINT_Pos))
#define USB_HOST_PINTSMRY_MASK      (0x00FF)   /**< \brief (USB_HOST_PINTSMRY) MASK Register */
...
#define USB_DESCADD_DESCADD_Msk     ((0xFFFFFFFF) << USB_DESCADD_DESCADD_Pos)
#define USB_DESCADD_DESCADD(value)  (USB_DESCADD_DESCADD_Msk & ((value) << USB_DESCADD_DESCADD_Pos))
#define USB_DESCADD_MASK            (0xFFFFFFFF) /**< \brief (USB_DESCADD) MASK Register */
...
#define USB_PADCAL_TRANSP_Msk       ((0x1F) << USB_PADCAL_TRANSP_Pos)
...
#define USB_PADCAL_TRANSN_Msk       ((0x1F) << USB_PADCAL_TRANSN_Pos)
...
#define USB_PADCAL_TRIM_Msk         ((0x7) << USB_PADCAL_TRIM_Pos)
#define USB_PADCAL_TRIM(value)      (USB_PADCAL_TRIM_Msk & ((value) << USB_PADCAL_TRIM_Pos))
#define USB_PADCAL_MASK             (0x77DF)   /**< \brief (USB_PADCAL) MASK Register */
...
#define USB_DEVICE_EPCFG_EPTYPE0_Msk ((0x7) << USB_DEVICE_EPCFG_EPTYPE0_Pos)
...
#define USB_DEVICE_EPCFG_EPTYPE1_Msk ((0x7) << USB_DEVICE_EPCFG_EPTYPE1_Pos)
...
#define USB_DEVICE_EPCFG_NYETDIS    ((0x1) << USB_DEVICE_EPCFG_NYETDIS_Pos)
#define USB_DEVICE_EPCFG_MASK       (0xF7)     /**< \brief (USB_DEVICE_EPCFG) MASK Register */
...
#define USB_HOST_PCFG_PTOKEN_Msk    ((0x3) << USB_HOST_PCFG_PTOKEN_Pos)
...
#define USB_HOST_PCFG_BK            ((0x1) << USB_HOST_PCFG_BK_Pos)
#define USB_HOST_PCFG_PTYPE_Pos     3            /**< \brief (USB_HOST_PCFG) Pipe Type */
#define USB_HOST_PCFG_PTYPE_Msk     ((0x7) << USB_HOST_PCFG_PTYPE_Pos)
#define USB_HOST_PCFG_PTYPE(value)  (USB_HOST_PCFG_PTYPE_Msk & ((value) << USB_HOST_PCFG_PTYPE_Pos))
#define USB_HOST_PCFG_MASK          (0x3F)     /**< \brief (USB_HOST_PCFG) MASK Register */
...
#define USB_HOST_BINTERVAL_BITINTERVAL_Msk ((0xFF) << USB_HOST_BINTERVAL_BITINTERVAL_Pos)
#define USB_HOST_BINTERVAL_BITINTERVAL(value) (USB_HOST_BINTERVAL_BITINTERVAL_Msk & ((value) << USB_HOST_BINTERVAL_BITINTERVAL_Pos))
#define USB_HOST_BINTERVAL_MASK     (0xFF)     /**< \brief (USB_HOST_BINTERVAL) MASK Register */
...
#define USB_DEVICE_EPSTATUSCLR_DTGLOUT ((0x1) << USB_DEVICE_EPSTATUSCLR_DTGLOUT_Pos)
#define USB_DEVICE_EPSTATUSCLR_DTGLIN_Pos 1            /**< \brief (USB_DEVICE_EPSTATUSCLR) Data Toggle IN Clear */
#define USB_DEVICE_EPSTATUSCLR_DTGLIN ((0x1) << USB_DEVICE_EPSTATUSCLR_DTGLIN_Pos)
#define USB_DEVICE_EPSTATUSCLR_CURBK_Pos 2            /**< \brief (USB_DEVICE_EPSTATUSCLR) Current Bank Clear */
#define USB_DEVICE_EPSTATUSCLR_CURBK ((0x1) << USB_DEVICE_EPSTATUSCLR_CURBK_Pos)
...
#define USB_DEVICE_EPSTATUSCLR_STALLRQ_Msk ((0x3) << USB_DEVICE_EPSTATUSCLR_STALLRQ_Pos)
...
#define USB_DEVICE_EPSTATUSCLR_BK0RDY ((0x1) << USB_DEVICE_EPSTATUSCLR_BK0RDY_Pos)
#define USB_DEVICE_EPSTATUSCLR_BK1RDY_Pos 7            /**< \brief (USB_DEVICE_EPSTATUSCLR) Bank 1 Ready Clear */
#define USB_DEVICE_EPSTATUSCLR_BK1RDY ((0x1) << USB_DEVICE_EPSTATUSCLR_BK1RDY_Pos)
#define USB_DEVICE_EPSTATUSCLR_MASK (0xF7)     /**< \brief (USB_DEVICE_EPSTATUSCLR) MASK Register */
...
#define USB_HOST_PSTATUSCLR_DTGL    ((0x1) << USB_HOST_PSTATUSCLR_DTGL_Pos)
#define USB_HOST_PSTATUSCLR_CURBK_Pos 2            /**< \brief (USB_HOST_PSTATUSCLR) Curren Bank clear */
#define USB_HOST_PSTATUSCLR_CURBK   ((0x1) << USB_HOST_PSTATUSCLR_CURBK_Pos)
#define USB_HOST_PSTATUSCLR_PFREEZE_Pos 4            /**< \brief (USB_HOST_PSTATUSCLR) Pipe Freeze Clear */
#define USB_HOST_PSTATUSCLR_PFREEZE ((0x1) << USB_HOST_PSTATUSCLR_PFREEZE_Pos)
#define USB_HOST_PSTATUSCLR_BK0RDY_Pos 6            /**< \brief (USB_HOST_PSTATUSCLR) Bank 0 Ready Clear */
#define USB_HOST_PSTATUSCLR_BK0RDY  ((0x1) << USB_HOST_PSTATUSCLR_BK0RDY_Pos)
#define USB_HOST_PSTATUSCLR_BK1RDY_Pos 7            /**< \brief (USB_HOST_PSTATUSCLR) Bank 1 Ready Clear */
#define USB_HOST_PSTATUSCLR_BK1RDY  ((0x1) << USB_HOST_PSTATUSCLR_BK1RDY_Pos)
#define USB_HOST_PSTATUSCLR_MASK    (0xD5)     /**< \brief (USB_HOST_PSTATUSCLR) MASK Register */
...
#define USB_DEVICE_EPSTATUSSET_DTGLOUT ((0x1) << USB_DEVICE_EPSTATUSSET_DTGLOUT_Pos)
#define USB_DEVICE_EPSTATUSSET_DTGLIN_Pos 1            /**< \brief (USB_DEVICE_EPSTATUSSET) Data Toggle IN Set */
#define USB_DEVICE_EPSTATUSSET_DTGLIN ((0x1) << USB_DEVICE_EPSTATUSSET_DTGLIN_Pos)
#define USB_DEVICE_EPSTATUSSET_CURBK_Pos 2            /**< \brief (USB_DEVICE_EPSTATUSSET) Current Bank Set */
#define USB_DEVICE_EPSTATUSSET_CURBK ((0x1) << USB_DEVICE_EPSTATUSSET_CURBK_Pos)
...
#define USB_DEVICE_EPSTATUSSET_STALLRQ_Msk ((0x3) << USB_DEVICE_EPSTATUSSET_STALLRQ_Pos)
...
#define USB_DEVICE_EPSTATUSSET_BK0RDY ((0x1) << USB_DEVICE_EPSTATUSSET_BK0RDY_Pos)
#define USB_DEVICE_EPSTATUSSET_BK1RDY_Pos 7            /**< \brief (USB_DEVICE_EPSTATUSSET) Bank 1 Ready Set */
#define USB_DEVICE_EPSTATUSSET_BK1RDY ((0x1) << USB_DEVICE_EPSTATUSSET_BK1RDY_Pos)
#define USB_DEVICE_EPSTATUSSET_MASK (0xF7)     /**< \brief (USB_DEVICE_EPSTATUSSET) MASK Register */
...
#define USB_HOST_PSTATUSSET_DTGL    ((0x1) << USB_HOST_PSTATUSSET_DTGL_Pos)
#define USB_HOST_PSTATUSSET_CURBK_Pos 2            /**< \brief (USB_HOST_PSTATUSSET) Current Bank Set */
#define USB_HOST_PSTATUSSET_CURBK   ((0x1) << USB_HOST_PSTATUSSET_CURBK_Pos)
#define USB_HOST_PSTATUSSET_PFREEZE_Pos 4            /**< \brief (USB_HOST_PSTATUSSET) Pipe Freeze Set */
#define USB_HOST_PSTATUSSET_PFREEZE ((0x1) << USB_HOST_PSTATUSSET_PFREEZE_Pos)
#define USB_HOST_PSTATUSSET_BK0RDY_Pos 6            /**< \brief (USB_HOST_PSTATUSSET) Bank 0 Ready Set */
#define USB_HOST_PSTATUSSET_BK0RDY  ((0x1) << USB_HOST_PSTATUSSET_BK0RDY_Pos)
#define USB_HOST_PSTATUSSET_BK1RDY_Pos 7            /**< \brief (USB_HOST_PSTATUSSET) Bank 1 Ready Set */
#define USB_HOST_PSTATUSSET_BK1RDY  ((0x1) << USB_HOST_PSTATUSSET_BK1RDY_Pos)
#define USB_HOST_PSTATUSSET_MASK    (0xD5)     /**< \brief (USB_HOST_PSTATUSSET) MASK Register */
...
#define USB_DEVICE_EPSTATUS_DTGLOUT ((0x1) << USB_DEVICE_EPSTATUS_DTGLOUT_Pos)
#define USB_DEVICE_EPSTATUS_DTGLIN_Pos 1            /**< \brief (USB_DEVICE_EPSTATUS) Data Toggle In */
#define USB_DEVICE_EPSTATUS_DTGLIN  ((0x1) << USB_DEVICE_EPSTATUS_DTGLIN_Pos)
#define USB_DEVICE_EPSTATUS_CURBK_Pos 2            /**< \brief (USB_DEVICE_EPSTATUS) Current Bank */
#define USB_DEVICE_EPSTATUS_CURBK   ((0x1) << USB_DEVICE_EPSTATUS_CURBK_Pos)
...
#define USB_DEVICE_EPSTATUS_STALLRQ_Msk ((0x3) << USB_DEVICE_EPSTATUS_STALLRQ_Pos)
...
#define USB_DEVICE_EPSTATUS_BK0RDY  ((0x1) << USB_DEVICE_EPSTATUS_BK0RDY_Pos)
#define USB_DEVICE_EPSTATUS_BK1RDY_Pos 7            /**< \brief (USB_DEVICE_EPSTATUS) Bank 1 ready */
#define USB_DEVICE_EPSTATUS_BK1RDY  ((0x1) << USB_DEVICE_EPSTATUS_BK1RDY_Pos)
#define USB_DEVICE_EPSTATUS_MASK    (0xF7)     /**< \brief (USB_DEVICE_EPSTATUS) MASK Register */
...
#define USB_HOST_PSTATUS_DTGL       ((0x1) << USB_HOST_PSTATUS_DTGL_Pos)
#define USB_HOST_PSTATUS_CURBK_Pos  2            /**< \brief (USB_HOST_PSTATUS) Current Bank */
#define USB_HOST_PSTATUS_CURBK      ((0x1) << USB_HOST_PSTATUS_CURBK_Pos)
#define USB_HOST_PSTATUS_PFREEZE_Pos 4            /**< \brief (USB_HOST_PSTATUS) Pipe Freeze */
#define USB_HOST_PSTATUS_PFREEZE    ((0x1) << USB_HOST_PSTATUS_PFREEZE_Pos)
#define USB_HOST_PSTATUS_BK0RDY_Pos 6            /**< \brief (USB_HOST_PSTATUS) Bank 0 ready */
#define USB_HOST_PSTATUS_BK0RDY     ((0x1) << USB_HOST_PSTATUS_BK0RDY_Pos)
#define USB_HOST_PSTATUS_BK1RDY_Pos 7            /**< \brief (USB_HOST_PSTATUS) Bank 1 ready */
#define USB_HOST_PSTATUS_BK1RDY     ((0x1) << USB_HOST_PSTATUS_BK1RDY_Pos)
#define USB_HOST_PSTATUS_MASK       (0xD5)     /**< \brief (USB_HOST_PSTATUS) MASK Register */
...
#define USB_DEVICE_EPINTFLAG_TRCPT_Msk ((0x3) << USB_DEVICE_EPINTFLAG_TRCPT_Pos)
...
#define USB_DEVICE_EPINTFLAG_TRFAIL_Msk ((0x3) << USB_DEVICE_EPINTFLAG_TRFAIL_Pos)
...
#define USB_DEVICE_EPINTFLAG_RXSTP  ((0x1) << USB_DEVICE_EPINTFLAG_RXSTP_Pos)
...
#define USB_DEVICE_EPINTFLAG_STALL_Msk ((0x3) << USB_DEVICE_EPINTFLAG_STALL_Pos)
#define USB_DEVICE_EPINTFLAG_STALL(value) (USB_DEVICE_EPINTFLAG_STALL_Msk & ((value) << USB_DEVICE_EPINTFLAG_STALL_Pos))
#define USB_DEVICE_EPINTFLAG_MASK   (0x7F)     /**< \brief (USB_DEVICE_EPINTFLAG) MASK Register */
...
#define USB_HOST_PINTFLAG_TRCPT_Msk ((0x3) << USB_HOST_PINTFLAG_TRCPT_Pos)
...
#define USB_HOST_PINTFLAG_TRFAIL    ((0x1) << USB_HOST_PINTFLAG_TRFAIL_Pos)
#define USB_HOST_PINTFLAG_PERR_Pos  3            /**< \brief (USB_HOST_PINTFLAG) Pipe Error Interrupt Flag */
#define USB_HOST_PINTFLAG_PERR      ((0x1) << USB_HOST_PINTFLAG_PERR_Pos)
#define USB_HOST_PINTFLAG_TXSTP_Pos 4            /**< \brief (USB_HOST_PINTFLAG) Transmit  Setup Interrupt Flag */
#define USB_HOST_PINTFLAG_TXSTP     ((0x1) << USB_HOST_PINTFLAG_TXSTP_Pos)
#define USB_HOST_PINTFLAG_STALL_Pos 5            /**< \brief (USB_HOST_PINTFLAG) Stall Interrupt Flag */
#define USB_HOST_PINTFLAG_STALL     ((0x1) << USB_HOST_PINTFLAG_STALL_Pos)
#define USB_HOST_PINTFLAG_MASK      (0x3F)     /**< \brief (USB_HOST_PINTFLAG) MASK Register */
...
#define USB_DEVICE_EPINTENCLR_TRCPT_Msk ((0x3) << USB_DEVICE_EPINTENCLR_TRCPT_Pos)
...
#define USB_DEVICE_EPINTENCLR_TRFAIL_Msk ((0x3) << USB_DEVICE_EPINTENCLR_TRFAIL_Pos)
...
#define USB_DEVICE_EPINTENCLR_RXSTP ((0x1) << USB_DEVICE_EPINTENCLR_RXSTP_Pos)
...
#define USB_DEVICE_EPINTENCLR_STALL_Msk ((0x3) << USB_DEVICE_EPINTENCLR_STALL_Pos)
#define USB_DEVICE_EPINTENCLR_STALL(value) (USB_DEVICE_EPINTENCLR_STALL_Msk & ((value) << USB_DEVICE_EPINTENCLR_STALL_Pos))
#define USB_DEVICE_EPINTENCLR_MASK  (0x7F)     /**< \brief (USB_DEVICE_EPINTENCLR) MASK Register */
...
#define USB_HOST_PINTENCLR_TRCPT_Msk ((0x3) << USB_HOST_PINTENCLR_TRCPT_Pos)
...
#define USB_HOST_PINTENCLR_TRFAIL   ((0x1) << USB_HOST_PINTENCLR_TRFAIL_Pos)
#define USB_HOST_PINTENCLR_PERR_Pos 3            /**< \brief (USB_HOST_PINTENCLR) Pipe Error Interrupt Disable */
#define USB_HOST_PINTENCLR_PERR     ((0x1) << USB_HOST_PINTENCLR_PERR_Pos)
#define USB_HOST_PINTENCLR_TXSTP_Pos 4            /**< \brief (USB_HOST_PINTENCLR) Transmit Setup Interrupt Disable */
#define USB_HOST_PINTENCLR_TXSTP    ((0x1) << USB_HOST_PINTENCLR_TXSTP_Pos)
#define USB_HOST_PINTENCLR_STALL_Pos 5            /**< \brief (USB_HOST_PINTENCLR) Stall Inetrrupt Disable */
#define USB_HOST_PINTENCLR_STALL    ((0x1) << USB_HOST_PINTENCLR_STALL_Pos)
#define USB_HOST_PINTENCLR_MASK     (0x3F)     /**< \brief (USB_HOST_PINTENCLR) MASK Register */
...
#define USB_DEVICE_EPINTENSET_TRCPT_Msk ((0x3) << USB_DEVICE_EPINTENSET_TRCPT_Pos)
...
#define USB_DEVICE_EPINTENSET_TRFAIL_Msk ((0x3) << USB_DEVICE_EPINTENSET_TRFAIL_Pos)
...
#define USB_DEVICE_EPINTENSET_RXSTP ((0x1) << USB_DEVICE_EPINTENSET_RXSTP_Pos)
...
#define USB_DEVICE_EPINTENSET_STALL_Msk ((0x3) << USB_DEVICE_EPINTENSET_STALL_Pos)
#define USB_DEVICE_EPINTENSET_STALL(value) (USB_DEVICE_EPINTENSET_STALL_Msk & ((value) << USB_DEVICE_EPINTENSET_STALL_Pos))
#define USB_DEVICE_EPINTENSET_MASK  (0x7F)     /**< \brief (USB_DEVICE_EPINTENSET) MASK Register */
...
#define USB_HOST_PINTENSET_TRCPT_Msk ((0x3) << USB_HOST_PINTENSET_TRCPT_Pos)
...
#define USB_HOST_PINTENSET_TRFAIL   ((0x1) << USB_HOST_PINTENSET_TRFAIL_Pos)
#define USB_HOST_PINTENSET_PERR_Pos 3            /**< \brief (USB_HOST_PINTENSET) Pipe Error Interrupt Enable */
#define USB_HOST_PINTENSET_PERR     ((0x1) << USB_HOST_PINTENSET_PERR_Pos)
#define USB_HOST_PINTENSET_TXSTP_Pos 4            /**< \brief (USB_HOST_PINTENSET) Transmit  Setup Interrupt Enable */
#define USB_HOST_PINTENSET_TXSTP    ((0x1) << USB_HOST_PINTENSET_TXSTP_Pos)
#define USB_HOST_PINTENSET_STALL_Pos 5            /**< \brief (USB_HOST_PINTENSET) Stall Interrupt Enable */
#define USB_HOST_PINTENSET_STALL    ((0x1) << USB_HOST_PINTENSET_STALL_Pos)
#define USB_HOST_PINTENSET_MASK     (0x3F)     /**< \brief (USB_HOST_PINTENSET) MASK Register */
...
#define USB_DEVICE_ADDR_ADDR_Msk    ((0xFFFFFFFF) << USB_DEVICE_ADDR_ADDR_Pos)
#define USB_DEVICE_ADDR_ADDR(value) (USB_DEVICE_ADDR_ADDR_Msk & ((value) << USB_DEVICE_ADDR_ADDR_Pos))
#define USB_DEVICE_ADDR_MASK        (0xFFFFFFFF) /**< \brief (USB_DEVICE_ADDR) MASK Register */
...
#define USB_HOST_ADDR_ADDR_Msk      ((0xFFFFFFFF) << USB_HOST_ADDR_ADDR_Pos)
#define USB_HOST_ADDR_ADDR(value)   (USB_HOST_ADDR_ADDR_Msk & ((value) << USB_HOST_ADDR_ADDR_Pos))
#define USB_HOST_ADDR_MASK          (0xFFFFFFFF) /**< \brief (USB_HOST_ADDR) MASK Register */
...
#define USB_DEVICE_PCKSIZE_BYTE_COUNT_Msk ((0x3FFF) << USB_DEVICE_PCKSIZE_BYTE_COUNT_Pos)
...
#define USB_DEVICE_PCKSIZE_MULTI_PACKET_SIZE_Msk ((0x3FFF) << USB_DEVICE_PCKSIZE_MULTI_PACKET_SIZE_Pos)
...
#define USB_DEVICE_PCKSIZE_SIZE_Msk ((0x7) << USB_DEVICE_PCKSIZE_SIZE_Pos)
...
#define USB_DEVICE_PCKSIZE_AUTO_ZLP ((0x1) << USB_DEVICE_PCKSIZE_AUTO_ZLP_Pos)
#define USB_DEVICE_PCKSIZE_MASK     (0xFFFFFFFF) /**< \brief (USB_DEVICE_PCKSIZE) MASK Register */
...
#define USB_HOST_PCKSIZE_BYTE_COUNT_Msk ((0x3FFF) << USB_HOST_PCKSIZE_BYTE_COUNT_Pos)
...
#define USB_HOST_PCKSIZE_MULTI_PACKET_SIZE_Msk ((0x3FFF) << USB_HOST_PCKSIZE_MULTI_PACKET_SIZE_Pos)
...
#define USB_HOST_PCKSIZE_SIZE_Msk   ((0x7) << USB_HOST_PCKSIZE_SIZE_Pos)
...
#define USB_HOST_PCKSIZE_AUTO_ZLP   ((0x1) << USB_HOST_PCKSIZE_AUTO_ZLP_Pos)
#define USB_HOST_PCKSIZE_MASK       (0xFFFFFFFF) /**< \brief (USB_HOST_PCKSIZE) MASK Register */
...
#define USB_DEVICE_EXTREG_SUBPID_Msk ((0xF) << USB_DEVICE_EXTREG_SUBPID_Pos)
...
#define USB_DEVICE_EXTREG_VARIABLE_Msk ((0x7FF) << USB_DEVICE_EXTREG_VARIABLE_Pos)
#define USB_DEVICE_EXTREG_VARIABLE(value) (USB_DEVICE_EXTREG_VARIABLE_Msk & ((value) << USB_DEVICE_EXTREG_VARIABLE_Pos))
#define USB_DEVICE_EXTREG_MASK      (0x7FFF)   /**< \brief (USB_DEVICE_EXTREG) MASK Register */
...
#define USB_HOST_EXTREG_SUBPID_Msk  ((0xF) << USB_HOST_EXTREG_SUBPID_Pos)
...
#define USB_HOST_EXTREG_VARIABLE_Msk ((0x7FF) << USB_HOST_EXTREG_VARIABLE_Pos)
#define USB_HOST_EXTREG_VARIABLE(value) (USB_HOST_EXTREG_VARIABLE_Msk & ((value) << USB_HOST_EXTREG_VARIABLE_Pos))
#define USB_HOST_EXTREG_MASK        (0x7FFF)   /**< \brief (USB_HOST_EXTREG) MASK Register */
...
#define USB_DEVICE_STATUS_BK_CRCERR ((0x1) << USB_DEVICE_STATUS_BK_CRCERR_Pos)
#define USB_DEVICE_STATUS_BK_ERRORFLOW_Pos 1            /**< \brief (USB_DEVICE_STATUS_BK) Error Flow Status */
#define USB_DEVICE_STATUS_BK_ERRORFLOW ((0x1) << USB_DEVICE_STATUS_BK_ERRORFLOW_Pos)
#define USB_DEVICE_STATUS_BK_MASK   (0x03)     /**< \brief (USB_DEVICE_STATUS_BK) MASK Register */
...
#define USB_HOST_STATUS_BK_CRCERR   ((0x1) << USB_HOST_STATUS_BK_CRCERR_Pos)
#define USB_HOST_STATUS_BK_ERRORFLOW_Pos 1            /**< \brief (USB_HOST_STATUS_BK) Error Flow Status */
#define USB_HOST_STATUS_BK_ERRORFLOW ((0x1) << USB_HOST_STATUS_BK_ERRORFLOW_Pos)
#define USB_HOST_STATUS_BK_MASK     (0x03)     /**< \brief (USB_HOST_STATUS_BK) MASK Register */
...
#define USB_HOST_CTRL_PIPE_PDADDR_Msk ((0x7F) << USB_HOST_CTRL_PIPE_PDADDR_Pos)
...
#define USB_HOST_CTRL_PIPE_PEPNUM_Msk ((0xF) << USB_HOST_CTRL_PIPE_PEPNUM_Pos)
...
#define USB_HOST_CTRL_PIPE_PERMAX_Msk ((0xF) << USB_HOST_CTRL_PIPE_PERMAX_Pos)
#define USB_HOST_CTRL_PIPE_PERMAX(value) (USB_HOST_CTRL_PIPE_PERMAX_Msk & ((value) << USB_HOST_CTRL_PIPE_PERMAX_Pos))
#define USB_HOST_CTRL_PIPE_MASK     (0xFF7F)   /**< \brief (USB_HOST_CTRL_PIPE) MASK Register */
